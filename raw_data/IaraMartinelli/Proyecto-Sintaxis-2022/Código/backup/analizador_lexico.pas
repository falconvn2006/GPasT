...
uses
   base,lista ;   //u lexico, u sintactico, base(tipos y leer_caracter, u pila u lista), u evaluador, u program principal
...
var
 lexema:string;
 complex:tsimbgram;                                    //cambiar lista
 control:longint;
 estado:boolean;
begin
//ingresar el archivo

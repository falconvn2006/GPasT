...
var
  WebModuleClass: TComponentClass = TDogRating;
...
procedure TDogRating.WebModuleCreate(Sender: TObject);
begin
...
procedure TDogRating.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;

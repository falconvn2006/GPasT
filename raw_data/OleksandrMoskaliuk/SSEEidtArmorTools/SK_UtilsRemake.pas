...
SetElementEditValues(newCondition, 'CTDA - CTDA\Type', '11000000');
    // set some needed properties
SetElementEditValues(newCondition, 'CTDA - CTDA\Comparison Value', '1');
SetElementEditValues(newCondition, 'CTDA - CTDA\Function', 'GetItemCount');
SetElementEditValues(newCondition, 'CTDA - CTDA\Inventory Object', Name(item));
SetElementEditValues(newCondition, 'CTDA - CTDA\Run On', 'Subject');
    // don't know what is this, but it should be equal to -1, if Function Runs On Subject
SetElementEditValues(newCondition, 'CTDA - CTDA\Parameter #3', '-1');
...
SetElementEditValues(newCondition, 'CTDA - CTDA\Type', '10010000');

    // set some needed properties
SetElementEditValues(newCondition, 'CTDA - CTDA\Comparison Value', '0');
SetElementEditValues(newCondition, 'CTDA - CTDA\Function', 'GetEquipped');
SetElementEditValues(newCondition, 'CTDA - CTDA\Inventory Object', Name(item));
SetElementEditValues(newCondition, 'CTDA - CTDA\Run On', 'Subject');
    // don't know what is this, but it should be equal to -1, if Function Runs On Subject
SetElementEditValues(newCondition, 'CTDA - CTDA\Parameter #3', '-1');
...
SetElementEditValues(newCondition, 'CTDA - CTDA\Type', '11000000');
    // set some needed properties
SetElementEditValues(newCondition, 'CTDA - CTDA\Comparison Value', '2');
SetElementEditValues(newCondition, 'CTDA - CTDA\Function', 'GetItemCount');
SetElementEditValues(newCondition, 'CTDA - CTDA\Inventory Object', Name(item));
SetElementEditValues(newCondition, 'CTDA - CTDA\Run On', 'Subject');
    // don't know what is this, but it should be equal to -1, if Function Runs On Subject
...
SetElementEditValues(newCondition, 'CTDA - CTDA\Type', '10000000');

    // set some needed properties
SetElementEditValues(newCondition, 'CTDA - CTDA\Comparison Value', '1');
SetElementEditValues(newCondition, 'CTDA - CTDA\Function', 'HasPerk');
SetElementEditValues(newCondition, 'CTDA - CTDA\Perk', GetEditValue(perk));
SetElementEditValues(newCondition, 'CTDA - CTDA\Run On', 'Subject');
    // don't know what is this, but it should be equal to -1, if Function Runs On Subject
SetElementEditValues(newCondition, 'CTDA - CTDA\Parameter #3', '-1');
...
i,
amountOfLeatherComponent // Leather for now
: integer;
currentKeywordEDID: string;
begin
itemSignature := Signature(itemRecord);
...
GetElementEditValues(itemRecord, 'DATA\Value')
* 0.025
);
...
if amountOfLeatherComponent < 1 then
amountOfLeatherComponent := 1;
...
addItem(recipeItems, getRecordByFormID('000DB5D2'), amountOfAdditionalComponent); // Leather

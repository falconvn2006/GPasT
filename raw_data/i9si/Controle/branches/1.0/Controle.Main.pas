...
type
  TControleMain = class(TUniForm)
    ...
    UniPanel9: TUniPanel;
    MenuPanel_02: TUniPanel;
    UniPanelEsq2: TUniPanel;
    ...
    MenuPanel_16: TUniPanel;
    UniPanel26: TUniPanel;
    MenuPanel_17: TUniPanel;
    ...
    BotaoMenuIntBergCheques: TUniButton;
    UniButton5: TUniButton;
    MenuPanel_18: TUniPanel;
    ...
    procedure BotaoMenuIntBergChequesClick(Sender: TObject);
...
uses
  ...
  Controle.Consulta.Integracao.BergCheques,
  Controle.Consulta.DocumentosFiscais.NFe;
...
procedure TControleMain.BotaoMenuIntBergChequesClick(Sender: TObject);
begin
  NovaAba(TFrame(TControleConsultaIntegracaoBergCheques),'Int. Berg Cheques',True)
end;
...
begin
  NovaAba(TFrame(TControleConsultaDocumentosFiscaisNFe), 'NFe de devolução', True);
end;
...
//        MenuPanel_18.Visible := LocalizaPanelMenu(MenuPanel_18.Name);
  ...
  //      MenuPanel_01.Visible := LocalizaPanelMenu(MenuPanel_01.Name);
        ...
        if Trim(CdsUsuarioPermissao.FieldByName('MENU_CLIENTE_REPRES_BOTAO').AsString) = 'P' then
          BotaoMenuClienteRepresentante.Enabled := True
        else
          BotaoMenuClienteRepresentante.Enabled := False;

        // Botões do MenuPanel_14 ----------------------------------------------------------------------
        if Trim(CdsUsuarioPermissao.FieldByName('MENU_DADOS_REPRES_BOTAO').AsString) = 'P' then
          BotaoMenuDadosRepresentante.Enabled := True
        else
          BotaoMenuDadosRepresentante.Enabled := False;

          // Botões do MenuPanel_14 ----------------------------------------------------------------------
        if Trim(CdsUsuarioPermissao.FieldByName('MENU_RECEBIVEIS_REPRES_BOTAO').AsString) = 'P' then
          BotaoMenuRecebiveisRepresentante.Enabled := True
        else
          BotaoMenuRecebiveisRepresentante.Enabled := False;

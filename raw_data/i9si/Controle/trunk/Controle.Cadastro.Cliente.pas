...
procedure TControleCadastroCliente.BotaoGeraCPFClick(Sender: TObject);
begin
  inherited;
  if DbComboTipo.Text = 'FÍSICA' then
  begin
  ...
  begin
    ControleMainModule.MensageiroSweetAlerta('Atenção', 'Disponível apenas para CPF');  
  end;
end;

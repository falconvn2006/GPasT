...
procedure Register;
begin
  RegisterComponents('Fabricio',[TShapeGU]);
end;

{ TShapeF }

constructor TShapeGU.Create(AOwner: TComponent);
begin
...
if   FCorrTemp=true then
  begin
     canvas.textout(6,203-7,'24');
    canvas.textout(6,175-7,'16');
    canvas.textout(12,147-7,'8');
    canvas.textout(12,119-7,'0');
    canvas.textout(9,91-7,'-8');
    canvas.textout(2,63-7,'-16');
    canvas.textout(2,33-10,'-24');
    end
    else
  begin
    canvas.textout(6,203-7,'50');
       canvas.textout(1,175-10,'150');
       canvas.textout(1,147-10,'250');
       canvas.textout(1,119-10,'350');
       canvas.textout(1,91-10,'450');
       canvas.textout(1,63-10,'550');
       canvas.textout(1,33-10,'650');
  end;
 ...
 if FescalaD=true then
  ...
  if   FCorrTemp=true then
  begin
    canvas.textout(90,203-7,'24');
    canvas.textout(90,175-7,'16');
    canvas.textout(90,148-7,'8');
    canvas.textout(90,119-7,'0');
    canvas.textout(90,92-7,'-8');
    canvas.textout(90,63-7,'-16');
    canvas.textout(90,33-10,'-24');
    end
  else
  begin
       canvas.textout(90,203-7,'50');
       canvas.textout(90,175-10,'150');
       canvas.textout(90,148-10,'250');
       canvas.textout(90,119-10,'350');
       canvas.textout(90,92-10,'450');
       canvas.textout(90,63-10,'550');
       canvas.textout(90,33-10,'650');
  end;
...
begin
 ...
 canvas.TextOut(42,210,inttostr(FPosicao));
...
procedure TShapeGU.SetEspaco(AValue: integer);
begin
  if FEspaco=AValue then Exit;
  FEspaco:=AValue;
end;

procedure TShapeGU.SetDivisoes(AValue: integer);
begin
  if FDivisoes=AValue then Exit;
  FDivisoes:=AValue;
end;

procedure TShapeGU.SetE1(AValue: string);
begin
  if FE1=AValue then Exit;
  FE1:=AValue;
end;

procedure TShapeGU.SetE2(AValue: string);
begin
  if FE2=AValue then Exit;
  FE2:=AValue;
end;

procedure TShapeGU.SetE3(AValue: string);
begin
  if FE3=AValue then Exit;
  FE3:=AValue;
end;

procedure TShapeGU.SetE4(AValue: string);
begin
  if FE4=AValue then Exit;
  FE4:=AValue;
end;

procedure TShapeGU.SetE5(AValue: string);
begin
  if FE5=AValue then Exit;
  FE5:=AValue;
end;

procedure TShapeGU.SetE6(AValue: string);
begin
  if FE6=AValue then Exit;
  FE6:=AValue;
end;

procedure TShapeGU.SetE7(AValue: string);
begin
  if FE7=AValue then Exit;
  FE7:=AValue;
end;

procedure TShapeGU.SetCorrTemp(AValue: boolean);
begin
  if FCorrTemp=AValue then Exit;
  FCorrTemp:=AValue;
end;

procedure TShapeGU.SetescalaD(AValue: Boolean);
begin
  if FescalaD=AValue then Exit;
  FescalaD:=AValue;
end;

procedure TShapeGU.SetMescala(AValue: Boolean);
begin
  if FMescala=AValue then Exit;
  FMescala:=AValue;
end;

procedure TShapeGU.SetNome(AValue: string);
begin
  if FNome=AValue then Exit;
  FNome:=AValue;
end;

procedure TShapeGU.SetNomeB(AValue: string);
begin
  if FNomeB=AValue then Exit;
  FNomeB:=AValue;
end;

procedure TShapeGU.Setper(AValue: boolean);
begin
...
procedure TShapeGU.SetPosicao(AValue: integer);
begin
  if FPosicao=AValue then Exit;
  FPosicao:=AValue;
end;

procedure TShapeGU.SetColorOfShape(Value: TColor);
begin

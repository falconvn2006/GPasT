...
//++Const -- start of section automatically generated from Scintilla.iface
    ...
    SC_UPDATE_CONTENT	 = 01;	//Contents, styling or markers have been changed.
    SC_UPDATE_SELECTION= 02;	//Selection has been changed.
    SC_UPDATE_V_SCROLL = 04;	//Scrolled vertically.
    SC_UPDATE_H_SCROLL = 08;	//Scrolled horizontally.

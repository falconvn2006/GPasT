...
interface
 uses
  ...
  BAPSolution;
 type
  IndividualArray = array of TBAPSolution;
  ...
  public
   ...
   Function FindTheSameIndividual( var x:TBAPSolution; var q:TInt):TBool;
...
{******************************************************************************}
 ...
 begin
  ...
  begin
   Individual[i]:=TBAPSolution.Create;
...
//         q | if such genotype exist q = number in this population else q = -1
 Function TPopulation.FindTheSameIndividual( var x:TBAPSolution; var q:TInt):TBool;
 var
  i,j,s : TInt;
  b     : TBool;
 begin

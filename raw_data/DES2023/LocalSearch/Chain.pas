...
type
	...
	public
		...
		Constructor init(var str5:MyText);
...
Constructor TChain.init(var str5:mytext);
	type 
		slovo=string[15];
		slovo1=string[100];
	var
...
procedure TChain.svpl(var l1,m1,u1,stock_cost:real);
label a3;
var
...
procedure TChain.svpl_lead_stock(var l1,m1,u1,stock_cost:real;
                                  var new_order:easy; position:integer);
label a3;
var
 order1:order; boo:boolean;
...
(*********************)
procedure TChain.svpl_incomplete(buf_var:integer;
                                var reduced_line_kind:integer;
                                var reduced_line:machine_array;
                                var stock_cost:real);
(*********************)
...
procedure TChain.Imitation(var Throughput_,StorageCost_:TReal);
(*------------------------------------------------------------------
     ������������ ��� �������� �����������������
     ���� �����
  ------------------------------------------------------------------ *)
...
me40:
        ...
        for i:=2 to m-1 do
        begin
//writeln(StorageCost_);
//writeln(MarkCour[i]);
//writeln(inv_coef);
//writeln(det_cost[i]^.h);
//writeln('--------------');
...
me42:
  ...
  //messages.SaveToFile('messages.csv');
  //messages.free;

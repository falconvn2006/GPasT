...
type
  ...
  public
    ...
    function GetTheoreticalProbabilityDistributionApprox(p_win: double;
      n_trials, k_wins: integer): double;
  end;
...
function TCSN.GetTheoreticalProbabilityDistributionApprox(p_win: double;
  n_trials, k_wins: integer): double;
var x, y, q_lost : double;
begin

  q_lost := 1 - p_win;
  x := (k_wins - 0.5 - (n_trials * p_win)) / sqrt(n_trials * p_win * q_lost );

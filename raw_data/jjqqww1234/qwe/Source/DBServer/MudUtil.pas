...
begin
  ...
  if CaseSensitive then begin
    ...
    while True do begin
      ...
      if i > 0 then begin  //str�� �� �ڷ�..
        t := n;
        n := t + (b - t) div 2;
      end else if i < 0 then begin //str�� �� ����..
        b := n;
        n := t + (b - t) div 2;
      end else begin
        {fail...}
...
begin
  DecodeDate(aaday, oyear, omonth, oday);   {���� ��}
  DecodeDate(Date, ayear, amonth, aday);    {���� ��}
  Result := (ayear - oyear) * 24 * 30 * 12 + (amonth - omonth) *
    24 * 30 + (aday - oday) * 24;
  DecodeTime(aatime, ohour, omin, osec, omsec); {���� �ð�}
  DecodeTime(Time, ahour, amin, asec, amsec);   {���� �ð�}

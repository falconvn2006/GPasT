   ...
   try
      ...
      asm
         ...
         @@NextByte:
            ...
            ///ja    @@SkipByte
            imul  eax, 256
            movzx ebx, [esi].byte   //�ҽ� ddsd.lpSurface;
            add   eax, ebx
   ...
   try
      ...
      asm
         ...
         @@FogNext:
            ...
            db $0F,$6F,$06           /// movq  mm0, [esi]       //8����Ʈ ���� sptr
...
//ssuf(system memory) -> dsuf(video memory)  : �̶��� ����� ��
//���̴� 8�� ���
procedure MMXBlt (ssuf, dsuf: TDirectDrawSurface);
var
...
begin
   ...
   // TO TEST PDS
   if Width >= ssuf.Width then Width := ssuf.Width;
   if Height >= ssuf.Height then Height := ssuf.Height;

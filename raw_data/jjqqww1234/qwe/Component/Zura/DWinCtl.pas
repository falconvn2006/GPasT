...
const
   ...
   WINTOP  = 60;
   WINRIGHT = 800-60;
   BOTTOMEDGE = 600-30;  //������ Bottom�� WINBOTTOM�� ���� �� ����.
...
begin
   ...
   if (MouseCaptureControl <> nil) then begin //MouseCapture �̸� �ڽ��� �켱
...
begin
   ...
   if ModalDWindow <> nil then begin
      if ModalDWindow.Visible then begin
         ...
         ModalDWindow := nil;
      Key := #0; //ModalDWindow�� KeyDown�� ��ġ�鼭 Visible=false�� ���ϸ鼭
             //KeyPress�� �ٽð��ļ� ModalDwindow=nil�� �ȴ�.
   end;

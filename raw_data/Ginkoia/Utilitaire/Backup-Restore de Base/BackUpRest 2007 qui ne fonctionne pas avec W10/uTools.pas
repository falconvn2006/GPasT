...
function TTools.ServiceStart(sMachine, sService : string ) : boolean;
var
  schm, schs  : SC_Handle;
  ss          : TServiceStatus;
  psTemp      : PChar;
...
function TTools.ServiceStop(sMachine, sService : string ) : boolean;
var
  schm, schs  : SC_Handle;
  ss          : TServiceStatus;
  dwChkP      : DWord;
...
function TTools.ShutDownWinUpdate: boolean;
begin
  if Win32Platform = VER_PLATFORM_WIN32_NT then
  begin
...
// Starts Interbase
//-----------------------------------------------------------------------------
function TTools.StartInterbase : boolean;
begin
  if Win32Platform = VER_PLATFORM_WIN32_NT then
  begin
...
function TTools.StartWinUpdate: boolean;
begin
  if Win32Platform = VER_PLATFORM_WIN32_NT then
  begin

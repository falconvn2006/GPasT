...
begin
   ...
   begin
      ...
      tpd.add('action', 'QRY');
      tpd.add('qry1', qry);
      if tpd.PostWaitTimeOut(clt, 'http://' + cUrl_Yellis + '/admin/base.php', 30000) then
      begin
         Body := TStringStream.Create('');
         Body.CopyFrom(clt.BodyStream['http://' + cUrl_Yellis + '/admin/base.php'], 0);
         S := BODY.DataString;
         Body.free;
      ...
      clt.FreeLink('http://' + cUrl_Yellis + '/admin/base.php');
      Application.processmessages;
      sleep(100);
   end;
   if trim(s) = '' then
...
begin
   ...
   begin
      ...
      tpd.add('action', 'SEL');
      tpd.add('sel', qry);
      if tpd.PostWaitTimeOut(clt, 'http://' + cUrl_Yellis + '/admin/base.php', 30000, Memo) then
      begin
         Body := TStringStream.Create('');
         Body.CopyFrom(clt.BodyStream['http://' + cUrl_Yellis + '/admin/base.php'], 0);
         S := BODY.DataString;

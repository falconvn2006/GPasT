...
uses Classes, SysUtils, Windows, StrUtils, DateUtils, TypInfo, RTTI, Math ;
...
type
  ...
  public
    ...
    class function ObjectToJSON(aObject : TObject ; aDefaultClass : TClass = nil) : string ;
...
//------------------------------------------------------------------------------
class function TJSON.ObjectToJSON(aObject: TObject ; aDefaultClass : TClass = nil): string;
var
  TypeInfo : PTypeInfo ;
  PropList : PPropList ;
  PropNum  : integer ;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Result := Result + '"className":"'+aObject.ClassName+'"' ;
        bFirst := false ;
      end;
      ...
      begin
        ...
        case PropInfo^.PropType^.Kind of
          ...
          tkClass   : Result := Result + ObjectToJSON(TObject(GetObjectProp(aObject, PropInfo, TObject))) ;

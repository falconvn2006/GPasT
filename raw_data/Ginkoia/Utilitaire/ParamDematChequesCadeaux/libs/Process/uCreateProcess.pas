  ...
  try
    ...
    try
      ...
      begin
        ...
        begin
          if (FParam = '')
            then ret := CreateProcessAsUser(hToken, nil, PChar(FCmd), @sa, @sa, true, NORMAL_PRIORITY_CLASS, nil, PChar(FPath), si, FProcessInfo)
            else ret := CreateProcessAsUser(hToken, nil, PChar(FCmd + FParam), @sa, @sa, true, NORMAL_PRIORITY_CLASS, nil, PChar(FPath), si, FProcessInfo);
        end else begin
          FInteractive := false ;
        end;
      ...
      begin
        if (FParam = '')
          then ret := CreateProcess(nil, PChar(FCmd), @sa, @sa, true, NORMAL_PRIORITY_CLASS, nil, PChar(FPath), si, FProcessInfo)
          else ret := CreateProcess(nil, PChar(FCmd + FParam), @sa, @sa, true, NORMAL_PRIORITY_CLASS, nil, PChar(FPath), si, FProcessInfo);
      end;
        ...
        try
          ...
          begin
            try
              ...
              if readCount > 0 then
              begin
                  //FStreamStdIn.WriteData(readBuffer, readCount);
            ...
            try
              ...
              begin
                //readCount := FStreamStdOut.ReadData(readBuffer, Length(readBuffer)) ;
            ...
            try
              ...
              begin
                //readCount := FStreamStdErr.ReadData(readBuffer, Length(readBuffer)) ;
  ...
  begin
    ...
    begin
      try
        ...
        if readCount > 0 then
        begin
            // FStreamStdOut.WriteData(readBuffer, readCount);
    ...
    begin
      try
        ...
        if readCount > 0 then
        begin
            //FStreamStdErr.WriteData(readBuffer, readCount);
    ...
    begin
      try
        ...
        begin
          // readCount := FStreamStdIn.ReadData(readBuffer, Length(readBuffer)) ;

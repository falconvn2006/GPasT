...
begin
  ...
  MemD_NK.SaveToTextFile('c:\test.txt');
  MemD_NK.LoadFromTextFile('c:\test.txt');
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
             IF MemD_NK.Locate('SOUS_FAMILLE',VarArrayOf([SSfamille]),[loCaseInsensitive]) then
             begin
                  MemD_Result.FieldByName('Rayon').asstring := MemD_NK.FieldByName('RAYON').asstring;
                  MemD_Result.FieldByName('Famille').asstring := MemD_NK.FieldByName('FAMILLE').asstring;
             end
          END;
  ...
  // On cherche le premier fichier texte
    ...
    begin
      ...
      begin
        ...
        Lbx_Files.Checked[Lbx_Files.items.count - 1] := True;
...
begin
  ...
  begin
    if Lbx_Files.visible = True then
    begin

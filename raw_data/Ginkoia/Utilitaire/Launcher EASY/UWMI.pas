...
Const QWMI_OS    = 'SELECT BuildNumber, Caption, CSDVersion, CSName, FreePhysicalMemory, FreeSpaceInPagingFiles, FreeVirtualMemory, ' +
      ...
      QWMI_SERVICES_EASY = 'SELECT Name, PathName, StartMode, State, Status FROM Win32_Service WHERE Description=''Database Synchronization'' AND StartMode<>''Disabled'' AND Name=''EASY'' ';

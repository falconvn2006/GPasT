unit GKEasyComptageExport.Ressources;
...
resourcestring
  ...
  RS_INF_TH_CONNECT_D     = 'Démarrage du thread de test de la connexion.';
  RS_INF_TH_CONNECT_F     = 'Fin du thread de test de la connexion.';
  ...
  RS_ERR_CONNEXION        = 'Erreur de connexion à la base de données.'#13#10#13#10 + RS_ERR_QUITTER;
  RS_ERR_TRAITEMENT       = 'Un autre traitement bloque la connexion à la base de données.';
  RS_ERR_TRAITEMENT_QUIT  = 'Un autre traitement bloque la connexion à la base de données.'#13#10#13#10 + RS_ERR_QUITTER;
  RS_ERR_PARAM_INI        = 'Erreur de lecture du fichier d’initialisation.'#13#10#13#10 + RS_ERR_QUITTER;
  RS_ERR_PARAM_BASE       = 'Erreur lors du chargement des paramètres.'#13#10'%s'#13#10#13#10 + RS_ERR_QUITTER;
  ...
  RS_ERR_PARAM_ENREG      = 'Erreur lors de l’enregistrement des données %d'#160': Le paramètre n’existe pas dans la base.';
  RS_ERR_PARAM_ENREG_EXC  = 'Erreur lors de l’enregistrement des données %d'#160': %s - %s.';
  RS_ERR_BARRE_STATUS     = 'Erreur (%d/%d)'#160': %s - %s';

  RS_ERR_REQUETE_CODEADH  = 'Le magasin en cours n’a pas de code adhérant.';
  ...
  RS_INFO_TRAITEMENT      = 'Traitement en cours sur la plage du %s au %s - %s (tranche n°%d)';
  RS_INFO_TRAIT_TERMINE   = 'Traitement terminé.';
  ...
  RS_LIB_ARRET            = 'Arrêt du programme à %s';

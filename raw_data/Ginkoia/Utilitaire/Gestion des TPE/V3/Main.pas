...
procedure TFrm_Main.ApdComPort1PortClose(Sender: TObject);
begin
...
procedure TFrm_Main.ApdComPort1PortOpen(Sender: TObject);
begin
...
procedure TFrm_Main.ApdComPort1TriggerAvail(CP: TObject; Count: Word);
var i:integer;
    C:AnsiChar;
begin
    // Réponse du TPE
...
begin
    try
       try
         if (EtatEsclave=EEEcoute) or (ApdComPort1.open)
            then
              begin
            ...
            try
              ...
              On E:Exception do
                begin
                  ...
                  TraceLog('Ouverture Port Com ' + E.ClassName + ' COM'  +IntToStr(ApdComPort1.ComNumber),el_Info);
                  Busy := False;
                  result:=False;
                  exit;
                end;

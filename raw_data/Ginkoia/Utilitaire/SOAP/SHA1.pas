...
FUNCTION StrtoSha1 (S:String) : String ;
//******************************************************************************
implementation
...
begin
   ...
   for i := 0 to 19 do
   begin
      T := Int64 (LRot32(A, 5)) + Int64 (F1(B, C, D)) + Int64 (E) + Int64 (W[i]) + $5A827999 ;
      E := D; D := C; C := LRot32(B, 30); B := A; A := T;
   end;
   for i := 20 to 39 do
   begin
      T := Int64 (LRot32(A, 5)) + Int64 (F2(B, C, D)) + Int64 (E) + Int64 (W[i]) + $6ED9EBA1;
      E := D; D := C; C := LRot32(B, 30); B := A; A := T;
   end;
   for i := 40 to 59 do
   begin
      T := Int64 (LRot32(A, 5)) + Int64 (F3(B, C, D)) + Int64 (E) + Int64 (W[i]) + $8F1BBCDC;
      E := D; D := C; C := LRot32(B, 30); B := A; A := T;
   end;
   for i := 60 to 79 do
   begin
      T := Int64 (LRot32(A, 5)) + Int64 (F2(B, C, D)) + Int64 (E) + Int64 (W[i]) + $CA62C1D6;
      E := D; D := C; C := LRot32(B, 30); B := A; A := T;
   end;
   Data.Hash[0] := Int64 (Data.Hash[0]) + Int64 (A);
   Data.Hash[1] := Int64 (Data.Hash[1]) + Int64 (B);
   Data.Hash[2] := Int64 (Data.Hash[2]) + Int64 (C);
   Data.Hash[3] := Int64 (Data.Hash[3]) + Int64 (D);
   Data.Hash[4] := Int64 (Data.Hash[4]) + Int64 (E);

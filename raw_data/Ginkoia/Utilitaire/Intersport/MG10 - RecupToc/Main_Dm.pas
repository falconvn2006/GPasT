...
type
  TDm_Main = class(TDataModule)
    ...
    Cds_MagasinMAG_CODEADH: TStringField;
    Cds_Octete: TClientDataSet;
    Cds_OcteteOld_OCTID: TIntegerField;
    Cds_OcteteNew_OCTID: TIntegerField;
    Cds_OctMag: TClientDataSet;
    Cds_OcLignes: TClientDataSet;
    Cds_OcDetail: TClientDataSet;
    Cds_OctMagOld_OCMID: TIntegerField;
    Cds_OctMagNew_OCMID: TIntegerField;
    Cds_OcLignesOld_OCLID: TIntegerField;
    Cds_OcLignesNew_OCLID: TIntegerField;
    Cds_OcDetailOld_OCDID: TIntegerField;
    Cds_OcDetailNew_OCDID: TIntegerField;

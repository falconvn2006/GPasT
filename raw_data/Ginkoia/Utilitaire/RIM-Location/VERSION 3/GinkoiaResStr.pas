...
const
  ...
  // Module Decloture
  //----------------------------
  UilDeclotureRecep    = 'modifier - BON DE RECEPTION - Décloture';
  UilDeclotureRetFourn = 'modifier - RETOUR FOURNISSEUR - Décloture';
  UilDeclotureBonRapp  = 'modifier - BON DE RAPPROCHEMENT - Décloture';
//JB
  UILModuleRapprochementAuto  = 'RAPPROCHEMENT AUTO';
  UILMenu_ClotureReception          = 'menu - gérer les produits - RECEPTION - Clôture du document';
  UILMenu_ClotureRetourFournisseur  = 'menu - gérer les produits - RETOURS FOURNISSEURS - Clôture doc';
  MsgErrPasAccesClotureReception = 'Vous n''avez pas accès à la clôture du document de réception !';
  MsgErrPasAccesClotureRetourFournisseur = 'Vous n''avez pas accès à la clôture du document de retour fournisseur !';
  MsgErrPasAccesDecloture = 'Vous n''avez pas accès, le fournisseur du document est identifié avec rapprochement automatique';
  MsgErrBonEnRapprochementAutomatique = 'Impossible de %s ce bon car ce document vous a été transmis par la centrale';
//

  RS_TXT_DECLOTURE_Erreur              = 'Erreur';
  RS_TXT_DECLOTURE_Confirmation        = 'Confirmation';
  RS_TXT_DECLOTURE_Infos               = 'Information';
  RS_TXT_DECLOTURE_EXERCCOMMNOTOK      = 'Vous ne pouvez pas déclôturer un retour fournisseur dont l''exercice comptable est clôturé';
  RS_TXT_DECLOTURE_BONRAPPCLOT         = 'Vous ne pouvez pas déclôturer ce document, car il est rattaché à un bon de rapprochement clôturé';
  RS_QRY_DECLOTURE_CONFIRMATION        = 'Etes vous sûr de vouloir déclôturer ce document ?';
  RS_TXT_DECLOTURE_BONRAPPECNOTOK      = 'Vous ne pouvez pas déclôturer un bon de rapprochement dont l''excercice comptable est clôturé';
  RS_TXT_DECLOTURE_BONRAPPEXPTCOMPTA   = 'Vous ne pouvez pas déclôturer un bon de rapprochement qui a été exporté en comptabilité';
  RS_QRY_DECLOTURE_BONRAPPCONFIRM      = 'Confirmez-vous la déclôture du bon de rapprochement affiché ?';
  RS_QRY_DECLOTURE_CONFIRMLSTBONRAPP   = 'Confirmez-vous la déclôture des documents sélectionnés ?';
  RS_TXT_DECLOTURE_BONRAPPLSTOKPARTIEL = 'Tous les documents sélectionnés n''ont pas été déclôturés car ils sont exportés en comptabilité ou l''exercice commercial associé est clôturé';
  RS_TXT_DECLOTURE_BONRAPPLSTOK        = 'Tous les documents sélectionnées ont été déclôturés';
  RS_TXT_DECLOTURE_RECEPEXERCCOMPNOTOK = 'Vous ne pouvez pas déclôturer une réception d''un exercice comptable qui est clôturé';

  // ---------------------------
  // Module Archivage
  // ---------------------------
  UilModuleArchivage = 'ARCHIVAGE';
  UilModuleDemande = 'Archivage – Demander un archivage';
  UilModuleDeployer = 'Archivage – Déployer une archive';
  UilModuleSupprimer = 'Archivage – Supprimer une archive';

  // ---------------------------
  // Autorisation Contact client
  // ---------------------------

  RS_TXT_AUTOCOM_NOEXPLOIT = 'Non exploitable';
  RS_TXT_AUTOCOM_LOCALE = 'Locale';
  RS_TXT_AUTOCOM_NATIONAL = 'Nationale';
  //--------------------------------------------------------------------------------
  // Module et permission Transfert Inter-magasin avancée
  //--------------------------------------------------------------------------------
  UILModuleTimGestionAvancee = 'TIM - GESTION AVANCEE';
  UILMenuTimAvancee          = 'menu - gérer les produits - TRANSF. INTERMAGASIN Avancé';
//  UILModuleTimForceEcart     = 'modifier - Trans. IM Avancé - Forcer un contrôle en écart';
//  UILModuleTimValid          = 'modifier - Trans. IM Avancé - Valider avec écarts/sans contrôle';
  UILModuleTimForceStock     = 'modifier - Trans. IM Avancé - Forcer la mise à jour du stock';
  UILModuleTimModifFinali    = 'modifier - Trans. IM Avancé - Modifier finalisation';
  UILModuleTimGererControle  = 'modifier - Trans. IM Avancé - Gérer les contrôles';

  UILModuleTimVisu           = 'modifier - Trans. IM Avancé - Visualiser un écart';
  UILModuleTimForcerValidOrg = 'modifier - Trans. IM Avancé - Forcer validation avec qté origine';
  UILModuleTimForcerQtePres  = 'modifier - Trans. IM Avancé - Valider avec création bon écarts';
  UILModuleTimModifTarifTaux = 'modifier - Trans. IM Avancé - Modifier type de tarif et taux';
//JB
  UILModuleTimModifMagOrigine = 'modifier - Trans. IM Avancé - Modifier magasin origine';
  UILModuleTimModifMagDestination = 'modifier - Trans. IM Avancé - Modifier magasin destination';
//

  // Module FidBox
  UILModuleFidBox = 'FIDBOX';
  // Module Cross Canal
  UILModuleCrossCanal = 'CROSSCANAL';
  // Module Intersport
  UILModuleInterSport = 'CENTRALE INTERSPORT';

  // Module BaseNationale GoSport
//JB
  UILModuleBaseNationaleGoSport = 'BASE NATIONALE GOSPORT';
//  

  // Module GOSport et Courir
  UILModuleGoSport = 'GOSPORT';
  UILModuleCourir  = 'COURIR';

  //module Sport 2000
  UILModuleSP2K  = 'SPORT 2000';

  // Acompte Web
  UILModuleAcompteWeb = 'ACOMPTEWEB';
  UILAcompteAnnule = 'Caisse - Suppression des acomptes web';

  // Module MULTICOLIS pour Go sport       
  UILModuleMultiColis = 'MULTICOLIS';

  // Module STOCKIT pour EKOSPORT
  UILModuleEkoStockit = 'EKOSPORT';

  // Module Offre de réduction
  UILModuleOFR = 'OFFRE DE REDUCTION';

  // Module Analyse détaillée par poste
  UILModuleAnalysePoste = 'ANALYSE PAR POSTE';
  ...
  RS_ERR_CLIENTENCOURS = 'Fonction utilisable uniquement s''il n''y a pas de client en cours';
  RS_ERR_PASDERESA = 'Aucune réservation n''a été trouvé.';
  RS_ERR_PASDEQUESTION = 'Le paramétrage des questions est incomplet pour les types : %s'
                + #13#10
                + 'Paramétrage / Paramétrage de la location / Paramétrage des questions à poser';
  //--------------------------------------------------------------------------------
  ...
  // Module et permission BL Fournisseurs automatique
  //--------------------------------------------------------------------------------
  UILModuleMobileApp = 'MOBILITE' ;

  //--------------------------------------------------------------------------------
  // Module pour CapAdresse
  //--------------------------------------------------------------------------------
  UILModuleCapAdresse = 'CAPADRESSE';

  //--------------------------------------------------------------------------------
  // Module pour L'export de fiche modèle
  //--------------------------------------------------------------------------------
  UILModuleExportModeleGenerique = 'EXPORT GENERIQUE';
  ...
  UILMenu_LocNettoyageLoc = 'menu - location - NETTOYAGE DES ARCHIVES DE LOCATION';
  ...
  UILMenu_ExportCaTVA = 'menu -diriger & admin- Compta - Export CA TVA par Client';
  ...
  UILMenu_TablBordLoc = 'menu -diriger & admin- Ed. Location - TABLEAU DE BORD';
  ...
  UILMenu_AnalyseVentePoste = 'menu -diriger & admin- ctrl de l''activité - ANALYSE PAR POSTE';
  ...
  UILModif_OFR = 'modifier - Offres de réductions en cours';
  ...
  //--------------------------------------------------------------------------------
  // Permissions des fonctions des commande web
  //--------------------------------------------------------------------------------
  UILVoirMenu_CommandeWEB           = 'menu - vendre - Commande WEB';
  UILModif_CommandeWEB              = 'modifier - Commande WEB';
  UILArchiver_CommandeWEB           = 'modifier - Commande WEB - Archiver';
  UILRefuser_CommandeWEB            = 'modifier - Commande WEB - Refuser';
  UILChangeDateRetrait_CommandeWEB  = 'modifier - Commande WEB - Date retrait';
  UIPreparer_CommandeWEB            = 'modifier - Commande WEB - Préparer';
  //--------------------------------------------------------------------------------
  ...
  UILMenu_AnalyseModele = 'menu -diriger & admin- ctrl de l''activité - ANALYSE AU MODELE';
  ...
  UILMenu_GestionLots = 'menu - gérer les produits -gestion articles- GESTION DES LOTS';
  ...
  UILMenu_ZoneChalandise = 'menu - gérer la relation client - ZONE DE CHALANDISE';
  ...
  UILMenu_OFR = 'menu - gérer les produits -gestion articles- Offres de réduction';
  UILMenu_ParamOFRCentrale = 'menu - paramétrage - Offres de réduction';
  UILMedu_GestionDoublonsCB = 'menu - Gérer les produits - Gestion des doublons de CB';

  //--------------------------------------------------------------------------------
  // Droits pour la gestion des avoirs
  //--------------------------------------------------------------------------------
  UILModif_Avoirs_Suppr = 'Caisse - Gestion Suppression/Réactivation des avoirs';
  UILModif_Avoirs_Valide = 'CAISSE - Changement de validité d''un avoir';
  UILModif_Avoirs_Emission = 'CAISSE - Emission des avoirs';
  UILModif_Avoirs_reprise = 'CAISSE - Reprise des avoirs';
  UILMenu_ListeDesAvoirs = 'menu -diriger & admin- ctrl des caisses - LISTE DES AVOIRS' ;

  //--------------------------------------------------------------------------------
  // Droits pour Cross Canal en caisse
  //--------------------------------------------------------------------------------
  UILCaisse_CrossCanal_Voir = 'caisse - Commandes WEB - Voir les commandes';
  UILCaisse_CrossCanal_Modif = 'caisse - Commandes WEB - Modifier les commandes';
  UILCaisse_CrossCanal_Retrait = 'caisse - Commandes WEB - Retrait des commandes';
//JB
  UILCaisse_CrossCanal_PrixVente = 'CAISSE - Commande WEB – Modifier prix vente';
//  

  //--------------------------------------------------------------------------------
  // Droits pour le stock idéal
  //--------------------------------------------------------------------------------
  UILMenu_EtatStockIdeal = 'menu - gérer les produits -analyse du stock- STOCK IDEAL';
  UILMenu_Stock_Ideal_Fnc_Dispo =  'menu - gérer les produits -analyse du stock- STOCK IDEAL/DISPO';
  ...
  UILModuleCRDProsodie = 'CARTECADEAUPROSODIE';
  UILMenuParamCRDProsodie = 'menu - paramétrage - Carte cadeau Prosodie';
  UILCaisseCRDProsodie = 'caisse - Achat/vente Carte cadeau Prosodie';

  UILModuleCRDCOURRIR = 'CARTECADEAUCOURIR';
  UILMenuParamCRDCOURRIR = 'menu - paramétrage - Carte cadeau Courir';
  UILCaisseCRDCOURRIR = 'caisse - Achat/vente Carte cadeau Courir';

  UILModuleCRDISF = 'CARTE CADEAU ISF';
  UILMenuParamCRDISF = 'menu - paramétrage - Carte cadeau ISF';
  UILCaisseCRDISF = 'caisse - Achat/vente Carte cadeau ISF';

  UILCaisseCRDPRIXDiff = 'caisse - Vente carte cadeau avec prix different';
  UILCaisseCRDDotation = 'Création de carte de type "Dotation"';

  UILMenuEtatRecapCarteCadeau = 'menu -diriger & admin- ctrl des caisses - Etat Recap. Carte Cadeau';
  UILMenuSoldeCarteCadeau = 'menu -diriger & admin- ctrl des caisses - Solde Carte Cadeau';
  UILModifCarteSaisieDebit = 'modifier - Carte Cadeau - Saisie Débit';

  UILNegQteNegative = 'menu - vendre - gestion du négoce - QUANTITE NEGATIVE';

  //--------------------------------------------------------------------------------
  // MODULE Dematerialisation des chèques cadeaux
  //--------------------------------------------------------------------------------
  UILDematChequeCadeauModeDeconnecte = 'CAISSE - Chèque cadeau - Mode déconnecté';
  UILModuleDematChequeCadeau = 'DEMATCHEQUECADEAU';


//JB
  //--------------------------------------------------------------------------------
  // Module et permission Sauvegarde, Restitution Configuration DBGrilleHP
  //--------------------------------------------------------------------------------
  UILModulePersonnel = 'Configuration des grilles - Configuration personnelle';
  UILModuleGroupe = 'Configuration des grilles - Configuration de groupe';
  UILModulePublique = 'Configuration des grilles - Configuration publique';
  UILModuleSuppConfig = 'Configuration des grilles - Suppression des configurations';
//
  //--------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------
  // Module et permission Import générique v2
  //--------------------------------------------------------------------------------
  UILModuleImportGeneriqueV2          = 'IMPORT GENERIQUE V2';
  UILModuleImportGeneriqueV2_Acces    = 'Import générique - Accès';
  UILModuleImportGeneriqueV2_Modifier = 'Import générique - Modifier';
  UILModuleImportGeneriqueV2_Forcer   = 'Import générique - Forcer';
  ...
  Type13 = 'Reste Du';
  Type14 = 'Bon Achat Interne'; // -> pas de fonction dans la caisse
  Type15 = 'Bon Achat Externe'; // -> pas de fonction dans la caisse
  Type16 = 'Règlement';
  ...
  type44 = 'Classement des clients sur Bon de location';
  ...
  Type76 = 'Carte cadeau';
  Type77 = 'Consultation solde carte cadeau';
  Type78 = 'Fidélité Intersport';
  Type79 = 'Calcul de réglage fixation';
  Type80 = 'Remise montant ligne et S/T';
  Type81 = 'Remise montant sur total général';
  Type82 = 'Emission d''avoirs';
  Type83 = 'Reprise d''avoirs';
  Type84 = 'Réédition d''un avoir';
  Type85 = 'Bon Réduction fidélité';
  Type86 = 'Carte cadeau';
  Type87 = 'Consultation solde carte cadeau';
  Type88 = 'Désactivation carte cadeau';
  Type89 = 'Carte cadeau';
  Type90 = 'OP Caisse';
  Type91 = 'Retour ticket';
  Type92 = 'Carte cadeau';
  Type93 = 'Consultation solde carte cadeau';
  Type94 = 'Désactivation carte cadeau';
  Type95 = 'Acompte Web';
  Type96 = 'Annuler Acompte Web en cours';
  Type97 = 'Carte cadeau Cylande';          // -> pas de fonction dans la caisse
  Type98 = 'Consultation Solde CC Cylande'; // -> pas de fonction dans la caisse
  Type99 = 'Annulation Acompte Web';          
  Type100 = 'Ticket client';
  Type101 = 'Retrait de commande web';
  Type102 = 'Recherche Réservations';
  Type103 = 'Démat Chèque Cadeau';
  Type104 = 'Contrôle des Chèques Cadeaux';
  
const
  // Messages relatifs à la saisie des Quantités
  RS_ERR_QTE_NEGATIVE         = 'Vous ne pouvez pas saisir de quantité négative';
  RS_ERR_QTE_OVERLOAD         = 'Vous ne pouvez pas saisir de quantité supérieure à 999999';

  // Changement taux de TVA, caisse et GINKOIA
  ErrInvalidTva = 'Taux de TVA incorrect';

  // Message relatifs à la gestion des modes d'encaissement
  RS_TXT_MODEENC_EquFidbox    = 'FIDBOX';
  RS_TXT_MODEENC_EquGoSport   = 'GOSPORT';
  RS_TXT_MODEENC_EquCourir    = 'COURIR';
  RS_TXT_MODEENC_Lab_Caption  = 'Equivalent %s';
  RS_TXT_MODEENC_Lk_Caption   = 'Liste des modes d''encaissement %s';

  // Messages relatifs aux consommations diverses
  RS_ERR_CONSOHS_NoSelection  = 'Vous devez sélectionner une ligne de réception pour utiliser cette fonction.';

  // Messages relatifs aux MultiColis {CaisseBN_Frm}                             
  RS_ERR_MULTICO_DateDepassee = 'La date de validité de ce multi-colis est dépassée';
  RS_ERR_MULTICO_Secondaire   = 'Impossible de vendre un article secondaire de multi-colis';
  RS_TXT_MULTICO_ConfSuppr    = 'Confirmez-vous la suppression du multi-colis ?';
  RS_TXT_MULTICO_StkNegMsgPri = 'Multi-colis: %s'+#13#13+'Attention, le stock du produit est négatif.'+#13+'Que souhaitez vous faire ?';
  RS_TXT_MULTICO_StkNegMsgSec = 'Multi-colis: %s - Articles: %d/%d '+#13#13+'Attention, le stock de %s est négatif.'+#13+'Que souhaitez vous faire ?';

  // Messages relatifs aux Import OC Web {MaketOCImportWeb_Frm}
  RS_TXT_OCWEB_CSV_Entete     = 'ARTID;COUID;TGFID;SKU;PRIXSOLDE';
  RS_TXT_OCWEB_DB_Commentaire = 'OC Atipic %s';
  RS_TXT_OCWEB_ImportProgress = 'Importation de l''OC Web en cours...';
  RS_TXT_OCWEB_ImportDlgBilan = 'Importation de l''OC - Bilan'#13#10+'Ajouté : %d'+#13#10+'Ignoré : %d';
  RS_ERR_OCWEB_FichInexistant = 'Le fichier d''import OC Web "%s" n''existe pas.';
  RS_ERR_OCWEB_FichVide       = 'Le fichier d''import OC Web "%s" est vide';
  RS_ERR_OCWEB_FichNonConform = 'Le fichier d''import OC Web "%s" ne correspond pas au format attendu'+#13#10+'Erreur détectée ligne %d';
  RS_ERR_OCWEB_ArtInexistants = 'Le fichier d''import OC Web "%s" ne contient aucun article référencé'+#13#10+'Opération annulée';
  ...
  Crit_ErrNoAxeFac = 'Charger les modèles non positionnés sur un axe facultatif';
  ...
  PasDeLocationEnCours = 'Il n''y a pas de location en cours';
  ...
  RS_TXT_EXPORT_FISCAL_CLIENT = 'Export des ventes detaillé par client et taux de TVA';
  RS_TXT_ANSE_ANVENTE = 'Analyse des ventes';
  RS_TXT_ANSE_ANVENTEPOSTE = 'Analyse détaillée des ventes par poste';
  ...
  RS_TXT_COMMON_ANABIG      = 'Cette analyse comporte un trop grand nombre de lignes (%s).'#13#10'Veuillez affiner vos critères' ; 
  ...
  RS_TXT_COMMON_REPLICCOUR  = 'Une réplication est en cours.'#13#10#13#10'Opération mise en attente, Merci de patienter'#133;
  ...
  infoNettoyageRapprochement = 'Nettoyage des bons de rapprochement, veuillez patienter...';
  ...
  ChangeDomaineIntersport = 'Changement de domaine non permis pour le domaine Intersport';
  ...
  ErrCodePointRelaisChronopost = 'Code du point relais obligatoire';
  ...
  ErrPostableInvalidChronoRelais = 'Le N° de portable doit commencer par 06 ou 07 et doit contenir 10 chiffres pour Chrono Relais';
  ...
  ErrDoublonTva = 'Ce code est déjà attribué à un taux de TVA.' + #13#10 + 'Veuillez saisir un code unique pour ce taux.';
  ...
  OPNLiaison = 'Pas de liaison valide avec l''OPN-2001...';
  OPNVide = 'L''OPN ne contient pas de code barre...';

  // FC : 15/01/09
  StrMajAdrClient = 'L''adresse §0 a changé.' + #10#13 + 'Souhaitez vous mettre à jour l''adresse §1 du client ?';
  ...
  PasDeFidSiRemiseGlobale = 'Il n''est pas possible d''appliquer une remise fidélité sur un ticket avec une remise globale';
  ...
  LocEnCours = 'Attention, votre client a des locations en cours...';
  ...
  RefRech_ArtDjRec = 'Le modèle a déjà été récupéré par %s ' + #10#13 +
    'Vous devez répliquer pour y avoir accès';
  ...
  RefRech_PrbInt = 'Impossible de se connecter au site central,'#10#13'Vérifier votre accès internet';
  ...
  CstPasDroitModuleDetail = 'Votre version ne contient pas le module "§0".'#10#13'Veuillez contacter le service commercial de GINKOIA SA pour plus d''informations';
  ...
  MsgConfCtrlVP = 'Confirmez que vous avez bien contrôlé et noté les erreurs de saisie correspondantes à cette session de saisie !';
  ...
  ArtLocDateFabDansFuture = 'La date de fabrication ne peut être postérieure à la date du jour.';
  ArtLocDateAchSuppDateFab = 'La date de fabrication ne peut être postérieure à la date d''achat.';
  ...
  CstOuvImpossible = 'Vous devez fermer votre session en cours';
  ...
  CreerGTF = 'Confirmez la création d''une nouvelle grille de tailles....';
  ...
  RS_LOCATION_NO_BONARCHIVE = 'Il n''y a pas de bon de location archivés';
  RS_LOCATION_NETTOYAGE = 'Nettoyage des archives de locations';
  RS_LOCATION_CONFIRMATION = 'Etes vous sûr de vouloir supprimer les bons jusqu''à %s';
  RS_LOCATION_NETTOYAGE_TERMINE = 'Le nettoyage est terminé';
  RS_LOCATION_RIEN_A_NETTOYER = 'Il n''y a pas de bons à supprimer';
  ...
  ConfirmAnnulAcompte = 'Confirmez-vous l''annulation les acomptes payés pour les réservations sélectionnées ?';
  ...
  ValidTicket = 'Validation du ticket impossible,' + #13 + #10 + 'la somme des modes de paiement ne correspond pas au montant du ticket...';
  ...
  CstTpeServRedButton = 'Appuyez sur le bouton ROUGE du TPE ';
  ...
  locDocTotalHT = 'TOTAL LOCATION HT';
  locDocTotalTTC = 'TOTAL LOCATION TTC';
  locDocResteDu  = 'RESTE DU';
  ...
  LocMaterielDejaPerime = 'Attention, la date limite d’utilisation de ce matériel (EPI) a expiré depuis le %s.'#13#10'%sSouhaitez-vous poursuivre la %s ?';
  LocMaterielBientotPerime = 'Information : la date limite d’utilisation de ce matériel (EPI) expirera dans %d jours.'#13#10'%sSouhaitez-vous poursuivre la %s ?';
  ...
  AdrSocOblig = 'La saisie de l''adresse de la société est obligatoire...';
  AdrPaysSocOblig = 'La saisie du Pays de la société est obligatoire...';
  AdrCPSocOblig = 'La saisie du Code postal de la société est obligatoire...';
  AdrVilleSocOblig = 'La saisie de la Ville de la société est obligatoire...';
  CapitalSocOblig = 'La saisie du Capital de la société est obligatoire...';
  ...
  NegRemiseMemeCouleur = 'Voulez-vous appliquer cette remise' + #13 + #10 + 'à toutes les tailles de cette couleur ?';
  NegRemiseMemeModele = 'Voulez-vous appliquer cette remise' + #13 + #10 + 'à toutes les tailles couleurs du modèle ?';
  NegStockInsuffisant = 'La quantité que vous avez saisie dépasse la quantité en stock !';
  NegAttention1 = 'Attention ! lors de la prochaine saisie les prix unitaires TTC et la remise de chaque taille couleur seront réinitialisés avec celui de chaque première taille de la couleur';
  NegAttention2 = 'Attention ! les prix unitaires TTC et la remise de chaque taille couleur du modèle seront réinitialisés avec celui du tarif de base';
  NegAttention3 = 'Attention ! les prix saisis doivent être suppérieur à 0';
  NegConfirmation1 = 'Des quantités ont été saisies dans la grille.' + #13 + #10 + 'Etes vous sûr de vouloir abandonner la saisie ?';
  NegConfirmation2 = 'Toutes les saisies des tailles de cette même couleur vont être remplacées par les saisies de la première taille dans cette couleur.' + #13 + #10 + 'Etes vous sûr de vouloir remplacer ces saisies ?';
  NegConfirmation3 = 'Toutes les saisies des tailles / couleurs vont être remplacées par la saisie de la première taille / couleur.' + #13 + #10 + 'Etes vous sûr de vouloir remplacer ces saisies ?';
  ...
  RemiseMontantSup = 'Ce montant entraine une remise supérieure à 100%.' ;
  resTicketSansLigne = 'Ce ticket ne comporte aucune ligne' ;  
  ...
  LibIsAlreadyFact = 'Ce document a déja été transféré en facture';
...
//      'Quelques instants tout au plus...  Merci d''avance !';
  ...
  CstAnalVentePoste = 'Analyse des ventes par poste du §0 au §1 ';
  // Bruno @@ 20 14/05/2002
  ...
  MessRecepRemRal = 'Ce modèle a été saisi en commande avec une remise de %0:f'#160'%%.' + sLineBreak
    + 'La remise par défaut du bon de réception est de %1:f'#160'%%.' + sLineBreak+ sLineBreak
    + 'Faut-il utiliser la remise de la commande de %0:f'#160'%%'#160'?';

  MessRecepRemRalArt = 'Ce modèle a été saisi en commande avec une remise de %0:f'#160'%%.' + sLineBreak
    + 'La remise saisie en fiche modèle est de %1:f'#160'%%.' + sLineBreak + sLineBreak
    + 'Faut-il utiliser la remise de la commande de %0:f'#160'%%'#160'?';
  ...
  NegPxPublicHT = 'Px Public HT';
  NegPxPublicTTc = 'Px Public TTC';

  NegPxUnitRemHT = 'PU remisé HT';
  NegPxUnitRemTTc = 'PU remisé TTC';
...
//JB
  NegEntetPxNTTC = 'PU net TTC';
  NegEntetPxNHT = 'PU net HT';
//
  NegEntetMtTTC = 'Mt TTC';
  NegEntetMtHT = 'Mt HT';

//JB
  MsgConfirmDeleteConfig = 'Confirmez vous la suppression de cette configuration en base de données ?';
  MsgErrPasDroitSaveConfig = 'Vous n''avez aucun droit pour la sauvegarde des configurations de Grille';
  MsgErrNomExisteDeja = 'Ce nom de configuration existe déjà , confirmez vous la sauvegarde ?';
  MsgErrPasDeSauvegarde = 'Aucune sauvegarde mémorisée en base de données ! ';
  MsgErrVisibiliteTous = 'Vous devez sélectionner une autre visibilité que "Tous" ! ';
  MsgErrNomConfigDejaUtilise = 'Impossible, ce nom de configuration est déjà utilisé'#13#10'par l''utilisateur %s.'#13#10'Veuillez renseigner un nom différent.';

  MsgErrParamURLManquant = 'L''URL d''Esendex n''est pas renseigné dans le paramétrage "Général / Compte SMS"';

  DocGuideVersion = 'GuideVersion';
  DocRevisionVersion = 'revision';

  MsgConfirmCopieVendeurToutesLignesDoc = 'Voulez-vous appliquer ce vendeur à toutes les lignes du document ?';
//  
  ...
  CdeOkCloture = 'Confirmer la clôture de la commande affichée... ' + #13 + #10 +
    '  ATTENTION : ce document ne sera plus modifiable ! ';
  ...
  RecepOkDecloture = 'Confirmez-vous la déclôture de la réception affichée ?';
  ...
  ExportFiscalClient = 'Export fiscal client du §0 au §1  -  ';
  ExportCSVEnd = 'Export csv terminé';
  FileExportFiscalClient = 'Exports\ExportFiscalClient';
  ...
  Caissier = 'CAISSIER : ';
  TermineLigne = 'Les boutons seront actifs lorsque la ligne en cours sera validée...' + #13 + #10 + 'Terminez votre opération en cours ou cliquez sur la zone ''Code article''';
  ...
  LocationNumero = 'Location Numero : ';
...
//Saisie des opérations
  ...
  SupEncaissement = 'Confirmez-vous l''annulation de l''encaissement §0 d''un montant de §1 € ? ';
  ...
  GenerationBAL2 = 'Souhaitez-vous l''imprimer aujourd''hui?';
  ...
  ParamCFErrTypeC = 'Vous ne pouvez pas paramétrer un nombre de points à atteindre inférieur au nombre de points'
                  + ' minimum nécessaire à l''obtention d''un bon d''achat.' + sLineBreak + sLineBreak
                  + 'Veuillez modifier un des deux paramètres.';
  ...
  CstAchatCarteCadeau = 'ACHAT CARTE CADEAU';
  ...
  // message mondial relay
  msgErreurMondialRelayWS = 'Erreur lors de l''appel au web service Mondial Relay';
  msgErreurMondialRelayNoCollecte = 'Vous devez choisir un mode de collecte.';
  msgErreurMondialRelayPtsCollecte = 'Ce mode de collecte nécessite un point relais.';
  msgErreurMondialRelayNoLivraison = 'Vous devez choisir un mode de livraison.';
  msgErreurMondialRelayPtsLivraison = 'Ce mode de livraison nécessite un point relais.';
  msgErreurMondialRelayPtsInvalide = 'Le code du point relais est invalide'#10#13'(Doit être de la forme "code iso pays sur 2 caractères" + "code du point relais sur 6 caractères").';
  msgErreurMondialRelayCltNom = 'Les nom et prénom du client doivent être renseignés.';
  msgErreurMondialRelayCltAdr = 'L''adresse du client doit être renseignée.';
  msgErreurMondialRelayCltVille = 'La ville du client doit être renseignée.';
  msgErreurMondialRelayCltCP = 'Le code postale du client doit être renseigné.';
  msgErreurMondialRelayCltPays = 'Le pays du client doit être renseigné.';
  msgErreurMondialRelayCltTel = 'Dans le cadre d''une livraison avec rdv, le téléphone du client doit être renseigné.';
  ...
  //SKISET - ppour les parqmètres du webservice
  msgErrResCentVerifdataweb = 'Les enregistrements de stockage des paramètres du service web n''existent pas dans la base de données.';
  msgErrResCentVerifhttp = 'Configuration %s : Veuillez saisir une URL HTTP !!';
  msgErrResCentVeriflistshop = 'Configuration %s : Veuillez saisir un point d''entrée pour les magasins !!';
  msgErrResCentVerifoffer = 'Configuration %s : Veuillez saisir un point d''entrée pour les offres !!';
  msgErrResCentVerifbooking = 'Configuration %s : Veuillez saisir un point d''entrée pour les réservation !!';
  msgErrResCentVerifstatus = 'Configuration %s : Veuillez saisir un point d''entrée pours les status !!';
  msgErrResCentVerifcle = 'Configuration %s : Veuillez saisir un code clé !!';
  ...
  ModuleTranporteurMondialRelay = 'TRANSPORTEUR MONDIAL RELAY';
  ...
  BP_ASK_ConfirmerRecupColis = 'Confirmer que vous voulez récupérer les N° de colis' + #13#10 + 'de Colissimo, So-Colissimo et/ou de GLS.';
  ...
  PXPRECO_LstEtat_NoPropose = 'Tarifs à ne plus proposer';
  ...
  RS_TXT_PXPRECO_RECEPTIMM = 'Immédiate';
  RS_TXT_PXPRECO_RECEPTDIF = 'Différée à date';
  RS_TXT_PXPRECO_DATEMAJ = 'Date de mise à jour';
  RS_TXT_PXPRECO_ModeMaj = 'Mise à jour des prix de vente';
  ...
  RS_TXT_PXPRECO_WaitLoadPx = 'Traitement des prix à date en cours, veuillez patienter...';
  RS_TXT_PXPRECO_FinMAJPrix = 'Un tarif préconisé n''a pas été traité.';
  RS_TXT_PXPRECO_FinMAJPrix_plur = '%d tarifs préconisés n''ont pas été traités.';
  RS_TXT_PXPRECO_MAJCommandes = 'Mise à jour des commandes en cours'#133;  
  RS_TXT_PXPRECO_FinMAJCommandes = '%d commande(s) traitée(s) pour une quantité de %g article(s).';
  ...
  RS_ERR_PXPRECO_CollectObligatoire = 'Collection obligatoire';
  ...
  RS_ASK_ClotureExeComptable = 'Vous ne pourrez plus saisir de document pendant cette période'+#13#10+
                               'si vous clôturez cet exercice comptable.'+#13#10+
  ...
  RS_CAISSE_ERREUR_ENREG = 'Erreur lors de l''enregistrement du ticket.'#10#13'Vous devez resaisir la vente.'#10#13'Merci de faire une photocopie du ticket et de l''envoyer au support client Ginkoia.';
  RS_CAISSE_ERREUR_EXCEPT = 'Erreur dans le ticket, la caisse va se fermer.'#10#13'Vous devez resaisir la vente.'#10#13'Merci de faire une photocopie du ticket et de l''envoyer au support client Ginkoia.';

  // Gestion des lots
  RS_LOTS_ERREUR_ARTICLE = 'Cet article est déjà référencé dans ce lot.';
  RS_LOTS_CAPTION_GROUPE_VIDE = 'Goupe vide';
  RS_LOTS_ERREUR_ARTICLE_VIDE = 'Vous devez indiquer au moins un article pour le lot.';
  RS_LOTS_WARNING_GROUPE_VIDE = 'Attention : l''un des groupes de ce lot est vide.'#13'Il sera impossible de le valider.'#13'Voulez-vous continuer ?';
  RS_LOTS_GROUPE_NUMERO_USED = 'Numéro de groupe déjà utilisé.';
  RS_LOTS_GROUPE_NOM_USED = 'Nom de groupe déjà utilisé.';

  // Gestion des avoir
  RS_AVOIRS_CHARGEMENT = 'Chargement de la liste des avoirs...';

  // GoSport
  RS_GOSPORT_MODELECONTRACT = 'Vous ne pouvez pas ajouter de modèle Go Sport ou International.';

  // Courir
  RS_COURIR_MODELECONTRACT = 'Vous ne pouvez pas ajouter de modèle contractuel.';

  // NEGOCE
  // Message d'erreur d'utilisation de carte cadeau
  RS_NEGOCE_ARTICLE_CARTEKDO = 'Cet article n''est utilisable ici, c''est une carte cadeau';
  RS_PARAM_CARTEKDO_CLIENT_PAS_PRO = 'Le client choisi doit être professionnel.';

  RS_LIMITE_SAISIE_CONSODIV_GOSPORT = 'Le nombre saisi dépasse la limite autorisée.';

  // Erreur lorsque l'on essaye de quitter Ginkoia lorsqu'une analyse externe est en cours
  ERR_ANALYSE_EN_COURS = 'Une analyse est en cours.'#13#10#13#10'Vous ne pouvez pas quitter Ginkoia tant qu''elle n''est pas terminée'#133;

  RS_WS_ERROR_CLIENT = 'Base client nationale inaccessible.' + #13 + #10 +
                       'Le client sera mis à jour lorsque la base sera à nouveau disponible.';

  RS_WS_ERROR_PALIER = 'Base client nationale inaccessible.' + #13 + #10 +
                       'Le palier a quand même été appliqué.' + #13 + #10 +
                       'Le palier du client sera mis à jour dès que la base sera à nouveau disponible.';

  RS_WS_ERROR_FIDELITE = 'Le Serveur Fidélité Nationale n''est pas disponible.';

//==============================================================================
// WebVente Fidelite
//==============================================================================
  WebVenteFid_ServiceNotAvail  = 'Le serveur de fidélité n''a pas pu être contacté. Votre client a des bons d''achats mais ils ne sont peut-être plus valide.' ;
  WebVenteFid_BAUsedElsewhere  = 'Certains bons d''achats de votre client sont en cours d''utilisation ailleurs.' ;
  UIL_WebServiceFideliteCourirGoSport = 'WEB SERVICE FIDELITE COURIR/GOSPORT';
//==============================================================================

//==============================================================================
// Type de modèles
//==============================================================================
  RS_TYPEMODELE_Modele        = 'Modèle' ;
  RS_TYPEMODELE_RefSP2000     = 'Réf. SP2000' ;
  RS_TYPEMODELE_Catman        = 'Catman' ;
  RS_TYPEMODELE_ModeleCompl   = 'Mod. complémentaire' ;
  RS_TYPEMODELE_ModeleISF     = 'Modèle Intersport' ;
  RS_TYPEMODELE_ModeleLocal   = 'Modèle local' ;
  RS_TYPEMODELE_ModeleCourir  = 'Modèle contractuel' ;
  RS_TYPEMODELE_ModeleGoSport = 'Modèle GoSport' ;
  RS_TYPEMODELE_ModeleInt     = 'Modèle international' ;

  // annulation de ticket et avoir !
  RS_ANNUL_TICKET_ERREUR_AVOIR_GENERE = 'Le ticket ne peut pas être annulé car un avoir a été généré.';
  RS_ANNUL_TICKET_ASK_REPRINT_AVOIR   = 'Des avoirs ont été utilisés pour payer ce ticket.'#13'Ils vont être reactivés.'#13'Voulez-vous les rééditer ?';

  // annulation de ticket et Bon de réduction
  RS_ANNUL_TICKET_ERREUR_BR = 'Le ticket ne peut pas être annulé car des bons de réduction ont été générés ou utilisés.';

  RS_ANNUL_TICKET_INFO_OFFRE_PALIER = 'ATTENTION :  un bon de réduction ou une offre de fidélité est lié' + #13#10 + ' à ce ticket !' + #13#10 + 'L’annulation du ticket ne permettra pas de réactiver l’offre pour le client.';
  ConfToutVider                     = 'Confirmez-vous la supression de toutes les données saisies ? ';

  RS_PATIENTER_CHARGEMENT_DOUBLON_CB = 'Recherche des doublons, veuillez patienter ...';
  RS_PATIENTER_FINALISATION_TRAITEMENT_DOUBLON_CB = 'Finalisation du traitement, veuillez patienter ...';
  // gestion des doublons de CB
  RS_QUESTION_IMPOK = 'L''impression s''est-elle déroulée correctement ?';
  RS_INFO_PASDETIQ = 'Aucune étiquette à imprimer, l''ensemble des lignes sélectionnées n''a pas de stock';
  RS_QUESTION_DELFOURN = 'Voulez-vous supprimer les codes-barres fournisseur ?';

  RS_ERROR_ADRESSESOCIETE = 'Attention, le paramétrage Fiche société est incomplet' + #13#10
                          + 'Vous devez renseigner %s de la société %s' + #13#10
                          + 'pour respecter la législation des factures et facturettes.' + #13#10
                          + #13#10
                          + '(Paramétrage/Paramétrage Général/Fiche société)';

  RS_TXT_CLOTURE_OperationCommerciale  = 'Vous ne pouvez pas clôturer une Opération Commerciale active';
  RS_OCDetailErreurClotureSimple = 'Vous devez désactiver l''opération : "%s" avant de pouvoir l''archiver.';
  RS_OCDetailErreurClotureMultipleDebut = 'Vous devez désactiver les opérations : ';
  RS_OCDetailErreurClotureMultipleFin = 'avant de pouvoir les archiver.';
  RS_MessageET = ' et ';

//JBRetrait Caisse
  RS_TXT_REFUSER = 'Impossible de valider le retrait, aucun article retiré. Veuillez retirer au moins un article ou annuler la commande.';
  RS_QUESTION_REFUSER_COMMANDE = 'Êtes vous certain de vouloir annuler la commande n°[CDE] en totalité?';
//
  // Archivage : message en cas de ticket inéxistant
  RS_ERR_TKEID_INEXISTANT = 'Le détail de la pièce n’est pas disponible';

  // Caisse : erreur si le bouton OP Caisse est mal paramétré
  RS_ERR_BTN_OPCAISSE_PARAM_START ='ATTENTION, l''un des boutons OP Caisse n’a pas de mode d’encaissement associé. Merci de compléter le paramétrage pour utiliser cette fonction.';
  RS_ERR_BTN_OPCAISSE_PARAM_USE ='Impossible d’utiliser cette fonction. Vous devez associer ce bouton à un mode d’encaissement.';

...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure GenerateSport2kMailList : '+e.message);
  end;
  Finally
    Fmain.ResetGauge ;
    IMAP4.Free;
...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure CheckSport2KMail : '+e.message);
  end;
  finally
    lst.Free;
    MonXml.Free;

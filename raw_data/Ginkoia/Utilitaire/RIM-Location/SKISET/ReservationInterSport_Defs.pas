...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure GenerateISMailList : '+e.message);
  end;
  Finally
    Fmain.ResetGauge ;
    IMAP4.Free;
...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure ExtractDataFromFile : '+e.message);
  end;
  finally
    lst.Free;
    lst := nil ;
...
begin
  main.trclog('1Début de la procedure DoCreateReservationIS');
  Result := True;
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure DoCreateReservationIS (id_trace='+inttostr(cpt_trc)+') : '+e.message);
  end;
  finally
    Fmain.ResetGauge ;
   // CloseGaugeMessHP;
  end; // With / try
  main.trclog('1Fin de la procedure DoCreateReservationIS');
end;
...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure ArchiveMailIS : '+e.message);
  end;
  Finally
    lstMailBox.Free;
    lstRep.Free;

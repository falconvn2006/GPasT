...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure GenerateTwinnerMailList : '+e.message);
  end;
  //
  Finally
    lst.Free;
...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure CheckTwinnerMail : '+e.message);
  end;
  //
  finally
    lst.Free;

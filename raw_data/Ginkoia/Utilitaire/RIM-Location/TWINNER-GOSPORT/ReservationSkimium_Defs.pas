...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure GenerateSkmMailList : '+e.message);
  end;
  Finally
    Fmain.ResetGauge ;
    IMAP4.Free;
...
begin
  ...
  //PDB
    ...
    on e:exception do main.trclog('XErreur dans la procedure CheckSkmMail : '+e.message);
  end;
  finally
    lst.Free;
    MonXml.Free;

//$Log:
// 2    Utilitaires1.1         06/10/2021 11:43:12    Antoine JOLY    Rim :
...
begin
  ...
  begin
    ...
    if (Gestion_K_VERSION=TKV64) then
      IBS_Creation.SQL.Add('DECLARE VARIABLE KVER NUMERIC(18,0) ;')
    else
    ...
    IBS_Creation.SQL.Add('BEGIN');
    if (Gestion_K_VERSION=TKV64) then
      IBS_Creation.SQL.Add('KVER = GEN_ID(VERSION_ID,1);')
    else

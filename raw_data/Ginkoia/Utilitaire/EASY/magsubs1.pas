...
Updated by Angus Robertson, Magenta Systems Ltd, England, 20th April 2013
...
type
  TOSVersion = (OSW9x, OSNT4, OSW2K, OSWXP, OSVista, OS7, OS8) ;
// Windows Server 2003 is OSWXP, Windows Server 2008 is OSVista, 2008 R2 is 7, 2012 is 8
var
              ...
              // 16 Aug 2010 Vista and later reports editions with new API and literals
                ...
                begin
                  case ProductType of
                    ...
                    PRODUCT_CORE_ARM,PRODUCT_CORE_N, PRODUCT_CORE_COUNTRYSPECIFIC,
                        PRODUCT_CORE_SINGLELANGUAGE, PRODUCT_CORE: inf3 := ' Core' ;  // Windows 8, not sure what it means
                  else
...
begin
   ...
   begin
        ...
        {$ELSE}
        ULARGE_INTEGER(TempSize).LowPart := SearchRec.FindData.nFileSizeLow ;
        ULARGE_INTEGER(TempSize).HighPart := SearchRec.FindData.nFileSizeHigh ;
        FSize := ULARGE_INTEGER(TempSize).QuadPart ;
        {$IFEND}
...
begin
   ...
   begin
        ...
        {$ELSE}
        // Tokyo et Rio
        ULARGE_INTEGER(TempSize).LowPart := FindData.nFileSizeLow ;
        ULARGE_INTEGER(TempSize).HighPart := FindData.nFileSizeHigh ;
        FSize := ULARGE_INTEGER(TempSize).QuadPart ;
        //
        {$IFEND}
...
// keep OS version
    ...
    begin
        ...
        begin
            ...
            if Win32MinorVersion = 1 then MagRasOSVersion := OS7 ;   // and 2008 R2
            if Win32MinorVersion > 1 then MagRasOSVersion := OS8 ;   // and 2012
        end
        else

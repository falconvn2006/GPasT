...
uses
  ...
  ShellAPi,inifiles,registry,Tlhelp32,IdBaseComponent,
  IdComponent, IdTCPConnection, IdTCPClient, IdHTTP;


Const URLPath            = 'http://lame2.no-ip.com/algol/SRV_DEV/products/';
      LocalPath          = 'D:\Transferts\SRV_DEV\products\';
      InformationsFile   = 'gcb.txt';
      // LameMaitre         = 'RIAND';
      LameMaitre         = 'TOOLS1';
      // MAX_JSONLENGTH     = 100;
...
begin
    ...
    for i:=0 to ParamCount do
      begin
          if i>0 then result:= result + ' ' + paramstr(i);
      end;
end;
...
begin
  ...
  result := StringReplace(ResultWithSpaces, '*', '',[rfReplaceAll]);
...
begin
     ...
     Var_Glob.DIRECTORY:=string(buffer);
     Var_Glob.ComputerName := GetComputerNameFromWindows;
end.

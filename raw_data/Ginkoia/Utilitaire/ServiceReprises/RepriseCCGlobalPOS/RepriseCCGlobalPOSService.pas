...
begin
  ...
  try
    count := 0;
    AddLog(Format('Demarrage du service "Reprise cartes cadeaux Global POS" (délai %d minutes)', [Trunc(FDelais / 60)]));
    ...
    AddLog(Format('Arrêt du service "Reprise cartes cadeaux"', [FDelais]));

                  ...
                  try
                    ...
                    begin
                      ...
                      for k := 0 to Sufixes.Count -1 do
                        if k = 0 then
                          IBQue_Script.sql.Add('  case when ' + champs + ' like ''%' + Sufixes[k] + ''' then SubStr(' + champs + ', ' + inttoStr(Length(Inttostr(NumMagasin)) + 2)
                                             + ', f_bigstringlength(' + champs + ') - ' + IntToStr(Length(Sufixes[k])) + ')')
                        else
                          IBQue_Script.sql.Add('       when ' + champs + ' like ''%' + Sufixes[k] + ''' then SubStr(' + champs + ', ' + inttoStr(Length(Inttostr(NumMagasin)) + 2)
                                             + ', f_bigstringlength(' + champs + ') - ' + IntToStr(Length(Sufixes[k])) + ')');
                      if DoWithout then

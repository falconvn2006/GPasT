   ...
   begin
      ...
      begin
         ...
         try
            ...
            s := traitechaine(req + 'WHAT=ORDRE&QUOI=MD;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text);
            ...
            begin
               ...
               s := traitechaine(req + 'WHAT=ORDRE&QUOI=MD;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine');
               memo2.Lines.Insert(0,s);
               HTTP.oldGetWaitTimeOut(s, 3000);
               s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPY;'+LecteurLame+':\TECH\' + EAI + '\DelosQPMAgent.Providers.xml;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine\DelosQPMAgent.Providers.xml');
               memo2.Lines.Insert(0,s);
               HTTP.OldGetWaitTimeOut(s, 30000);
               s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPY;'+LecteurLame+':\TECH\' + EAI + '\DelosQPMAgent.Subscriptions.xml;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine\DelosQPMAgent.Subscriptions.xml');
               memo2.Lines.Insert(0,s);
               HTTP.OldGetWaitTimeOut(s, 30000);
               s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPY;'+LecteurLame+':\TECH\' + EAI + '\DelosQPMAgent.Subscriptions.xml;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine\DelosQPMAgent.InitParams.xml');
               memo2.Lines.Insert(0,s);
               HTTP.OldGetWaitTimeOut(s, 30000);
            end
            ...
            begin
               ...
               s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPYALL;'+LecteurLame+':\TECH\EAIGENE\EAI\;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine\EAI\');
               memo2.Lines.Insert(0,s);
               HTTP.oldGetWaitTimeOut(s, 30000);
               s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPYALL;'+LecteurLame+':\TECH\' + EAI + '\;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine\EAI\');
               memo2.Lines.Insert(0,s);
               HTTP.OldGetWaitTimeOut(s, 30000);
               s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPYALL;'+LecteurLame+':\EAI\MAJ\' + NomVersion + '\;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine\');
               memo2.Lines.Insert(0,s);
               HTTP.OldGetWaitTimeOut(s, 30000);
            end;
            s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPY;' + base + ';'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\GINKOIA.IB');
            memo2.Lines.Insert(0,s);
            HTTP.OldGetWaitTimeOut(s, 30000);
               ...
               begin
                  ...
                  begin
                    // Création de la base sur la lame
                     s := URL + 'Qry?' +
                        'BASE='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\GINKOIA.IB' +
                     ...
                     s := URL + 'recupgene?' + 'ID=' + theid +
                        ...
                        '&PANTIN=' + PlaceInstall +
                        '&VERSION=' + EAI +
                        '&DATA='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\GINKOIA.IB';
                     memo2.Lines.Insert(0,s);
                     s := traitechaine(s);
                     memo2.Lines.Insert(0,s);
                     HTTP.OldGetWaitTimeOut(s, 30000);
                     ...
                     s := URL + 'Qry?';
                     memo2.Lines.Insert(0,s);
                     s := s + 'BASE='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\GINKOIA.IB&';
                     memo2.Lines.Insert(0,s);
                     ...
                     s := traitechaine(req + 'WHAT=ORDRE&QUOI=ADD_EAI;' +
                        '\\' + tub.clt_machine + '\'+LecteurLame+'$\EAI\' + Copy(EAI, 1, length(eai) - 3) + ';' +
                        tub.nompournous + ';' +
                     ...
                     s := traitechaine(req + 'WHAT=ORDRE&QUOI=MD;\\' + tub.clt_machine + '\'+LecteurLame+'$\EAI\' + tub.clt_centrale + '\' + tub.nompournous + '\DATA');
                     memo2.Lines.Insert(0,s);
                     HTTP.oldGetWaitTimeOut(s, 3000);

                     s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPY;' +
                        LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\GINKOIA.IB;' +
                        '\\' + tub.clt_machine + '\'+LecteurLame+'$\EAI\' + tub.clt_centrale + '\' + tub.nompournous + '\DATA\GINKOIA.IB');
                     memo2.Lines.Insert(0,s);
                     HTTP.OldGetWaitTimeOut(s, 30000);
                     if not Attente(theid) then
                  ...
                  begin
                    { }
                     s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPYALL;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\origine\;'+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\');
                     memo2.Lines.Insert(0,s);
                     HTTP.OldGetWaitTimeOut(s, 30000);
                     if recup then
                        s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPY;' +
                           LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\GINKOIA.IB;' +
                           LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\GINKOIA.IB')
                     else
                        s := traitechaine(req + 'WHAT=ORDRE&QUOI=COPY;' +
                           LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\GINKOIA.IB;' +
                           LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\DATA\GINKOIA.IB');
                     memo2.Lines.Insert(0,s);
                     HTTP.OldGetWaitTimeOut(s, 30000);
                     if not Attente(theid) then
                     begin
                     ...
                     if recup then
                        s := URL + 'Qry?' +
                           'BASE='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\GINKOIA.IB' +
                           '&QRY=Update genparambase Set PAR_STRING=''' + tub.BAS_IDENT + ''' Where PAR_NOM=''IDGENERATEUR''&SPE=EXEC'
                     else
                        s := URL + 'Qry?' +
                           'BASE='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\DATA\GINKOIA.IB' +
                           '&QRY=Update genparambase Set PAR_STRING=''' + tub.BAS_IDENT + ''' Where PAR_NOM=''IDGENERATEUR''&SPE=EXEC';
                     s := traitechaine(s);
                     memo2.Lines.Insert(0,s);
                     HTTP.OldGetWaitTimeOut(s, 30000);
                     ...
                     if recup then
                        s := URL + 'recupgene?' + 'ID=' + theid +
                           ...
                           '&PLAGE_MAGASIN=' + tub.BAS_PLAGE +
                           '&NUMMAGASIN=' + tub.BAS_IDENT +
                           '&PATH='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '' +
                           '&SENDER=' + tub.BAS_SENDER +
                           '&DATABASE=' + nompournous +
                           '&EAI='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\' +
                           '&PANTIN=' + PlaceInstall +
                           '&VERSION=' + EAI +
                           '&DATA='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\GINKOIA.IB'
                     else
                        s := URL + 'recupgene?' + 'ID=' + theid +
                           '&PLAGE_PANTIN=' + plagePantin +
                           '&PLAGE_MAGASIN=' + tub.BAS_PLAGE +
                           '&NUMMAGASIN=' + tub.BAS_IDENT +
                           '&PATH='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\EAI' +
                           '&SENDER=' + tub.BAS_SENDER +
                           '&DATABASE=' + nompournous +
                           '&EAI='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\EAI\' +
                           '&PANTIN=' + PlaceInstall +
                           '&VERSION=' + EAI +
                           '&DATA='+LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\DATA\GINKOIA.IB';
                     s := traitechaine(s);
                     memo2.Lines.Insert(0,s);
                     HTTP.OldGetWaitTimeOut(s, 30000);
                     if not Attente(theid) then
                     ...
                     begin
                       if recup then
                          s := URL + 'thrd?' + 'ID=' + theid + '&WHAT=ORDRE&QUOI=ZIP_REP;' +
                             LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\;' +
                             LecteurLame+':\TRANSFERTS\BASES\' + tub.BAS_NOM + '.ZIP&OPTION=NOPSW'
                       else
                          s := URL + 'thrd?' + 'ID=' + theid + '&WHAT=ORDRE&QUOI=ZIP_REP;' +
                             LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\' + tub.BAS_NOM + '\;' +
                             LecteurLame+':\TRANSFERTS\BASES\' + tub.BAS_NOM + '.ZIP';
                       s := traitechaine(s);
                       memo2.Lines.Insert(0,s);
                       HTTP.OldGetWaitTimeOut(s, 30000);
                       s := Http.AsString(s);
  {$IFDEF DEBUG}memo1.lines.add(S); {$ENDIF}
                       if not Attente(theid) then
                       begin
                          Application.MessageBox(pchar(thelasterror), '  Erreur', Mb_OK);
                          EXIT;
            ...
            begin
              ...
              s := URL + 'thrd?' + 'ID=' + theid + '&WHAT=ORDRE&QUOI=DEL_ALL;' +
                 LecteurLame+':\TECH\SPLIT\' + ed_Chemin.text + '\';
              s := traitechaine(s);
              memo2.Lines.Insert(0,s);
              HTTP.OldGetWaitTimeOut(s, 30000);
              if not Attente(theid) then

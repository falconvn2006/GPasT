...
// $Rev: 8291 $
// File generated on 11/12/2012 11:12:46 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Developpement\Ginkoia\UTILITAIRE\Outils Tech\InstallClient.tlb (1)
...
// *********************************************************************//
  IInstallClientX = interface(IDispatch)
    ...
    procedure Recuperation; safecall;
    procedure SplitBase(recup: WordBool); safecall;
    procedure Parametrage; safecall;
...
// *********************************************************************//
  IInstallClientXDisp = dispinterface
    ...
    procedure Recuperation; dispid 15;
    procedure SplitBase(recup: WordBool); dispid 16;
    procedure Parametrage; dispid 17;
  end;
...
// *********************************************************************//
  ...
  public
    procedure Recuperation;
    procedure SplitBase(recup: WordBool);
...
procedure TInstallClientX.Recuperation;
begin
  DefaultInterface.Recuperation;
end;

procedure TInstallClientX.SplitBase(recup: WordBool);
begin
  DefaultInterface.SplitBase(recup);
end;

procedure TInstallClientX.Parametrage;
begin
  DefaultInterface.Parametrage;
end;

...
{                                                                                               }
{         Généré le : 11/09/2017 15:17:48                                                       }
{       Généré depuis : C:\Users\DEVXE\Downloads\V_DOSSIERS\DelosQPMAgent.Databases.xml         }
{   Paramètres stockés dans : C:\Users\DEVXE\Downloads\V_DOSSIERS\DelosQPMAgent.Databases.xdb   }
{                                                                                               }
{***********************************************************************************************}

unit DelosQPMAgentDatabases;
...
{ IXMLDataSourcesType }
  ...
  IXMLDataSourcesType = interface(IXMLNodeCollection)
    ['{14519A2B-FEE0-40BC-B646-4F4151F38F73}']
...
{ IXMLDataSourceType }
  ...
  IXMLDataSourceType = interface(IXMLNode)
    ['{9FB59BB9-AD67-4AF0-855B-A90363462C18}']
    { Accesseurs de propriétés }
...
{ IXMLParamsType }
  ...
  IXMLParamsType = interface(IXMLNodeCollection)
    ['{25865AA6-75F8-4ADB-8CEC-49DB9ED0C85D}']
    { Accesseurs de propriétés }
...
{ IXMLParamType }
  ...
  IXMLParamType = interface(IXMLNode)
    ['{D731F1E6-4401-47CF-90FB-5B8071994CD6}']
    { Accesseurs de propriétés }
    function Get_Name: UnicodeString;

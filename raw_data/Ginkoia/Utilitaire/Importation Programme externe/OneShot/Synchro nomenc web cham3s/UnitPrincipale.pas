...
begin
  ...
  OD_BdDSource.Execute;
  Chp_BdDSource.Text              := ExtractFilePath(OD_BdDSource.FileName);
  ChemSource                      := IncludeTrailingPathDelimiter(Chp_BdDSource.Text);
end;
...
begin
  ...
  //Info de version
  Frm_Principale.Caption  := Frm_Principale.Caption + Version;

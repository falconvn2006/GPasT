...
USES
    ...
    dxDBGrid, dxDBGridHP, dxDBTLCl, dxGrClms;
...
TYPE
    ...
    DBG_ReplicMois: TdxDBGridColumn;
    DBG_ReplicHEV_TYPE: TdxDBGridMaskColumn;
    DBG_ReplicHEV_RESULT: TdxDBGridCheckColumn;
    DBG_ReplicLETEMPS: TdxDBGridTimeColumn;
    DBG_ReplicLEMOIS: TdxDBGridMaskColumn;
    DBG_ReplicLANNEE: TdxDBGridMaskColumn;
    DBG_ReplicHEV_ID: TdxDBGridMaskColumn;
    DBG_ReplicEtat: TdxDBGridColumn;
    IBQue_ReplicBAS_NOM: TIBStringField;
    DBG_ReplicBAS_NOM: TdxDBGridColumn;
...
BEGIN
    ...
    CASE IBQue_ReplicHEV_TYPE.asInteger of
        ...
        19 :  IBQue_ReplicEtat.asString := 'Réplication compléte '; //CstUneReplication = 19;

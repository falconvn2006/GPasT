...
PROCEDURE initLogFileName(AMemo: TMemo; AStatusLab: TLabel; ANiveau: integer = 0; AppPath : string = ''; AFormatDateTime : string = 'yyyy_mm_dd');
...
BEGIN
  ...
  if AppPath = '' then
  begin
    sAppFileName := Application.ExeName;
  end
  else begin

...
USES
    ...
    RzDBButtonEditRv,
    Psock,
    NMFtp, IB_Process, IB_Script, wwDialog, wwidlg, wwLookupDialogRv,
    NMsmtp, UserDlg;
...
BEGIN
    ...
    MemD_sem.LoadFromTextFile(dsk +'semaine.csv');

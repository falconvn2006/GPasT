...
{ Inrefaces HTTP server }
  ...
  IXMLRequest = interface(IDispatch)
    ...
    procedure RaiseError(const ErrorCode, Value: WideString); safecall;
    function GetErrorCode: WideString; safecall;
    procedure ClearError; safecall;
...
{ DispInterface declaration for Dual Interface IXMLRequest }
  ...
  IXMLRequestDisp = dispinterface
    ...
    procedure RaiseError(const ErrorCode, Value: WideString); dispid 28;
    function GetErrorCode: WideString; dispid 29;
    procedure ClearError; dispid 30;
  end;
...
{ XMLCollection contains multiple XMLServices }
  ...
  IXMLCollection = interface(IDispatch)
    ...
    function CreateXMLCursor: IXMLCursor; safecall;
    function CreateXSLProc: IXSLProc; safecall;
...
{ DispInterface declaration for Dual Interface IXMLCollection }
  ...
  IXMLCollectionDisp = dispinterface
    ...
    function CreateXMLCursor: IXMLCursor; dispid 20;
    function CreateXSLProc: IXSLProc; dispid 21;
  end;

...
// PASTLWTR : $Revision: 1$
// File generated on 10/11/2000 12:02:09 from Type Library described below.
...
// they can be used.                                                          
// ************************************************************************ //
// Type Lib: D:\Data\Delphi\Tools\XMLComponents\Source\MSXML2_TLB.tlb (1)
...
// *********************************************************************//
  // !!! Made it compatible with all versions of MSXML
  DOMDocument = IXMLDOMDocument;
  DOMDocument26 = IXMLDOMDocument;
  DOMDocument30 = IXMLDOMDocument;
  // !!! Made it compatible with all versions of MSXML
  FreeThreadedDOMDocument = IXMLDOMDocument;
  FreeThreadedDOMDocument26 = IXMLDOMDocument;
  FreeThreadedDOMDocument30 = IXMLDOMDocument;
...
// !!! Made it compatible with all MSXML versions
...
// *********************************************************************//
  ...
  _xml_error = packed record
    ...
    _reserved1: {$ifdef VER100}DWORD{$else}LongWord{$endif};
    _reserved2: {$ifdef VER100}DWORD{$else}LongWord{$endif};
  end;
...
// *********************************************************************//
  CoXMLDocument = class
    // !!! Made it compatible with all MSXML versions
    class function Create: IXMLDocument;
    class function CreateRemote(const MachineName: string): IXMLDocument;
  end;
...
// !!! Made it compatible with all versions of MSXML
// !!! All following functions have been overloaded to support IXMLDOMDocument instead of IXMLDOMDocument2
...
class function CoDOMDocument26.Create: IXMLDOMDocument;
begin
  Result := CreateComObject(CLASS_DOMDocument26) as IXMLDOMDocument;
end;

class function CoDOMDocument26.CreateRemote(const MachineName: string): IXMLDOMDocument;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_DOMDocument26) as IXMLDOMDocument;
end;


class function CoDOMDocument30.Create: IXMLDOMDocument;
begin
  Result := CreateComObject(CLASS_DOMDocument30) as IXMLDOMDocument;
end;

class function CoDOMDocument30.CreateRemote(const MachineName: string): IXMLDOMDocument;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_DOMDocument30) as IXMLDOMDocument;
end;


class function CoFreeThreadedDOMDocument.Create: IXMLDOMDocument;
begin
  Result := CreateComObject(CLASS_FreeThreadedDOMDocument) as IXMLDOMDocument;
end;

class function CoFreeThreadedDOMDocument.CreateRemote(const MachineName: string): IXMLDOMDocument;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_FreeThreadedDOMDocument) as IXMLDOMDocument;
end;


class function CoFreeThreadedDOMDocument26.Create: IXMLDOMDocument;
begin
  Result := CreateComObject(CLASS_FreeThreadedDOMDocument26) as IXMLDOMDocument;
end;

class function CoFreeThreadedDOMDocument26.CreateRemote(const MachineName: string): IXMLDOMDocument;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_FreeThreadedDOMDocument26) as IXMLDOMDocument;
end;


class function CoFreeThreadedDOMDocument30.Create: IXMLDOMDocument;
begin
  Result := CreateComObject(CLASS_FreeThreadedDOMDocument30) as IXMLDOMDocument;
end;

class function CoFreeThreadedDOMDocument30.CreateRemote(const MachineName: string): IXMLDOMDocument;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_FreeThreadedDOMDocument30) as IXMLDOMDocument;
end;
...
// !!! Made it compatible with all versions of MSXML
class function CoXMLDocument.Create: IXMLDocument;
begin
  Result := CreateComObject(CLASS_XMLDocument) as IXMLDocument;
end;

class function CoXMLDocument.CreateRemote(const MachineName: string): IXMLDocument;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_XMLDocument) as IXMLDocument;
end;

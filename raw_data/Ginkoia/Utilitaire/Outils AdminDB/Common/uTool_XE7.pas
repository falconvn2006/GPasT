...
uses
  Windows, SysUtils, Classes, ComCtrls, DB, grids, stdctrls, checklst,
  ...
  DBClient, Controls, Mask, ExtCtrls, TypInfo, midasLib,
...
function ExecAndWaitProcess(Const AFileName, AParams, ADirectory: String; var AError: String; Const AUsedByThread: Boolean = False): integer; overload;
...
{===============================================================================
 Fonction     : DateTimeToIso8601
 Description  : permet de convertir un datetime en Iso8601
===============================================================================}
function DateTimeToIso8601(aDte : TDateTIme) : string ;
var
...
begin
  ...
  aOffset := (aTz.Bias + aTz.DaylightBias) div -60 ;
  if aOffset >= 0

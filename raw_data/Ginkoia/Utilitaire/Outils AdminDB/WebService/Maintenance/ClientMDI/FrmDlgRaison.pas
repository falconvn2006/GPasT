...
type
  TDlgRaisonFrm = class(TCustomGinkoiaDlgFrm)
    ...
    cxGridTWRaisonRAIS_ID: TcxGridDBColumn;
    cxGridTWRaisonRAIS_NOM: TcxGridDBColumn;
...
begin
  ...
  try
    ...
    dmClients.CDSRAISONS.FieldByName('DOSS_ID').AsInteger:= FDataSet.FieldByName('DOSS_ID').AsInteger;

...
begin
  ...
  if MessageDlg('Voulez-vous supprimer ?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
    begin
      dmClients.DeleteRecordByRessource('Horaire?SERV_ID=' + dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_SERVID').AsString +
                                        '&PRHO_ID=' + dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_ID').AsString);

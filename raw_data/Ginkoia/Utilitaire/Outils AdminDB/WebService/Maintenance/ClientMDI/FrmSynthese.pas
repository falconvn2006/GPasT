...
uses
  ...
  Dialogs, FrmCustomGinkoiaForm, ComCtrls, cxGraphics, cxControls, IdHTTP,
...
type
  ...
  TSyntheseFrm = class(TCustomGinkoiaFormFrm)
    ...
    cxGridTWModuleDOSS_DATABASE: TcxGridDBColumn;
    cxGridTWModuleMAGA_NOM: TcxGridDBColumn;
    cxGridTWModuleMODU_NOM: TcxGridDBColumn;
    cxGridModuleLevel1: TcxGridLevel;
    cxGridJeton: TcxGrid;
    cxGridTWJeton: TcxGridDBTableView;
    cxGridTWJetonDOSS_DATABASE: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviRepEtBaseHSSERV_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSDOSS_DATABASE: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviRepEtBaseHSEMET_DOSSID: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSEMET_INSTALL: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSEMET_MAGID: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSEMET_VERSID: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviRepEtBaseHSSERV_ID: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSHDBM_ID: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSHDBM_CYCLE: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSHDBM_OK: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSHDBM_COMMENTAIRE: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSHDBM_ARCHIVER: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSHDBM_DATE: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSRAIS_ID: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSRAIS_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviRepEtBaseHSDOSS_VIP: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviSrvReplicationSERV_ID: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviServeurSERV_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviServeurDOSS_DATABASE: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviServeurEMET_DOSSID: TcxGridDBColumn;
    cxGridDBTWSuiviServeurEMET_INSTALL: TcxGridDBColumn;
    cxGridDBTWSuiviServeurEMET_MAGID: TcxGridDBColumn;
    cxGridDBTWSuiviServeurEMET_VERSID: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviServeurSERV_ID: TcxGridDBColumn;
    cxGridDBTWSuiviServeurHDBM_ID: TcxGridDBColumn;
    cxGridDBTWSuiviServeurHDBM_CYCLE: TcxGridDBColumn;
    cxGridDBTWSuiviServeurHDBM_OK: TcxGridDBColumn;
    cxGridDBTWSuiviServeurHDBM_COMMENTAIRE: TcxGridDBColumn;
    cxGridDBTWSuiviServeurHDBM_ARCHIVER: TcxGridDBColumn;
    cxGridDBTWSuiviServeurHDBM_DATE: TcxGridDBColumn;
    cxGridDBTWSuiviServeurRAIS_ID: TcxGridDBColumn;
    cxGridDBTWSuiviServeurRAIS_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviServeurDOSS_VIP: TcxGridDBColumn;
    cxGridDBTWSuiviPortableEMET_ID: TcxGridDBColumn;
    cxGridDBTWSuiviPortableSERV_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviPortableDOSS_DATABASE: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviPortableEMET_DOSSID: TcxGridDBColumn;
    cxGridDBTWSuiviPortableEMET_INSTALL: TcxGridDBColumn;
    cxGridDBTWSuiviPortableEMET_MAGID: TcxGridDBColumn;
    cxGridDBTWSuiviPortableEMET_VERSID: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviPortableSERV_ID: TcxGridDBColumn;
    cxGridDBTWSuiviPortableHDBM_ID: TcxGridDBColumn;
    cxGridDBTWSuiviPortableHDBM_CYCLE: TcxGridDBColumn;
    cxGridDBTWSuiviPortableHDBM_OK: TcxGridDBColumn;
    cxGridDBTWSuiviPortableHDBM_COMMENTAIRE: TcxGridDBColumn;
    cxGridDBTWSuiviPortableHDBM_ARCHIVER: TcxGridDBColumn;
    cxGridDBTWSuiviPortableHDBM_DATE: TcxGridDBColumn;
    cxGridDBTWSuiviPortableRAIS_ID: TcxGridDBColumn;
    cxGridDBTWSuiviPortableRAIS_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviPortableDOSS_VIP: TcxGridDBColumn;
    cxGridDBTWSuiviVIPEMET_ID: TcxGridDBColumn;
    cxGridDBTWSuiviVIPSERV_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviVIPDOSS_DATABASE: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviVIPEMET_DOSSID: TcxGridDBColumn;
    cxGridDBTWSuiviVIPEMET_INSTALL: TcxGridDBColumn;
    cxGridDBTWSuiviVIPEMET_MAGID: TcxGridDBColumn;
    cxGridDBTWSuiviVIPEMET_VERSID: TcxGridDBColumn;
    ...
    cxGridDBTWSuiviVIPSERV_ID: TcxGridDBColumn;
    cxGridDBTWSuiviVIPHDBM_ID: TcxGridDBColumn;
    cxGridDBTWSuiviVIPHDBM_CYCLE: TcxGridDBColumn;
    cxGridDBTWSuiviVIPHDBM_OK: TcxGridDBColumn;
    cxGridDBTWSuiviVIPHDBM_COMMENTAIRE: TcxGridDBColumn;
    cxGridDBTWSuiviVIPHDBM_ARCHIVER: TcxGridDBColumn;
    cxGridDBTWSuiviVIPHDBM_DATE: TcxGridDBColumn;
    cxGridDBTWSuiviVIPRAIS_ID: TcxGridDBColumn;
    cxGridDBTWSuiviVIPRAIS_NOM: TcxGridDBColumn;
    cxGridDBTWSuiviVIPDOSS_VIP: TcxGridDBColumn;
    PrgsBr: TProgressBar;
  ...
  private
    ...
    procedure CallDetailModule(Const ADOSS_ID, AMAG_ID: integer);
    procedure CallDetailEmetteur(Const ADOSS_ID, AEMET_ID: integer);
...
procedure TSyntheseFrm.CallDetailEmetteur(const ADOSS_ID, AEMET_ID: integer);
var
  vClientFrm: TClientFrm;
  vClientsFrm: TClientsFrm;
begin
  MainFrm.ActClients.Execute;
  vClientsFrm:= TClientsFrm(MainFrm.FormExist['ClientsFrm']);
  if vClientsFrm = nil then
    Exit;
  vClientFrm:= vClientsFrm.ClientByDOSS_ID[ADOSS_ID];
  if vClientFrm <> nil then
    vClientFrm.ShowDetailEmetteur(AEMET_ID);
end;

procedure TSyntheseFrm.CallDetailModule(const ADOSS_ID, AMAG_ID: integer);
var
  vClientFrm: TClientFrm;
  vClientsFrm: TClientsFrm;
begin
...
begin
  ...
  if (DsHoraire.DataSet <> nil) and (DsHoraire.DataSet.RecordCount <> 0) and (FColumnSelected = nil) then
    CallDetailEmetteur(DsHoraire.DataSet.FieldByName('DOSS_ID').AsInteger,
...
begin
  ...
  if (DSJeton.DataSet <> nil) and (DSJeton.DataSet.RecordCount <> 0) then
    CallDetailEmetteur(DSJeton.DataSet.FieldByName('DOSS_ID').AsInteger,
...
begin
  ...
  if (DsModule.DataSet <> nil) and (DsModule.DataSet.RecordCount <> 0) then
    CallDetailModule(DsModule.DataSet.FieldByName('DOSS_ID').AsInteger,
                     DsModule.DataSet.FieldByName('MAGA_ID').AsInteger);
end;
...
procedure TSyntheseFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  Action:= caFree;
end;
...
begin
  ...
  try
    if dmClients.CDSHoraire.Active then
      begin
        dmClients.CDSHoraire.EmptyDataSet;
        dmClients.CDSHoraire.FieldDefs.Clear;
      end;
    ...
    { Creation des fields }
    dmClients.CDSHoraire.FieldDefs.Add('DOSS_ID', ftInteger);
    dmClients.CDSHoraire.FieldDefs.Add('DOSS_DATABASE', ftString, 255);
    ...
    if not dmClients.CDSHoraire.Active then
    ...
    PrgsBr.Visible:= True;
    PrgsBr.Min:= 0;
    PrgsBr.Max:= dmClients.CDSHoraire.FieldCount -1;
    PrgsBr.Position:= 0;
    ...
    for i:= 0 to dmClients.CDSHoraire.FieldCount - 1 do
      begin
        ...
        if PrgsBr <> nil then
          PrgsBr.Position:= PrgsBr.Position +1;
      end;
...
begin
  ...
  dmClients.DataSetToList(dmClients.CDS_SRV, 'SERV_ID', 'SERV_NOM', CmBxSrv.Items, Self);
...
begin
  ...
  try
    Buffer:= vIdHTTP.Get(GParams.Url + 'SynchronizeStarted?TYPESYNC=SYNCSRV');
    if Buffer <> '' then
      begin
    ...
    FThrdSuiviSrvReplication.APRHO_SERVID:= VarToStr(TGenerique(CmbBxListLame.Items.Objects[CmbBxListLame.ItemIndex]).ID);
...
begin
  try
    ...
    FreeAndNil(vParser);
    MainFrm.ShowPopupMsg('Suivi des serveurs de réplication',
                         CmbBxListLame.Items[CmbBxListLame.ItemIndex] + cRC + cRC +
                         'Recherche terminée.', mtInformation, 8000);
  end;
end;
...
begin
  ...
  try
    ...
    vPRHO_SERVID:= VarToStr(TGenerique(CmBxSrv.Items.Objects[CmBxSrv.ItemIndex]).ID);

    { Chargement Horaire pour un Lame }
    dmClients.XmlToDataSet('Emetteur?SERV_ID=' + vPRHO_SERVID, dmClients.CDSHoraire);
    Screen.Cursor:= crHourGlass;
    PlageEmetteurToDataSet;

    { Filtrage du ClientdataSet des paramètres horaire }
    dmClients.CDS_PARAMHORAIRES.Filtered:= False;
    dmClients.CDS_PARAMHORAIRES.Filter:= 'PRHO_SERVID=' + vPRHO_SERVID;
    dmClients.CDS_PARAMHORAIRES.Filtered:= True;

    { Chargement des parametres horaire pour une Lame }
    vCptNbDefault:= 0;
    if dmClients.CDS_PARAMHORAIRES.Locate('PRHO_DEFAUT', 1, []) then
      vCptNbDefault:= dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_NBREPLIC').AsInteger;
        ...
        if dmClients.CDS_PARAMHORAIRES.RecordCount <> 0 then
          begin
            ...
            while not dmClients.CDS_PARAMHORAIRES.Eof do
              begin
                if dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_DEFAUT').AsInteger <> 1 then
                  begin
                    vPlageHoraire.NbReplic:= vCptNbDefault;
                    vTDeb:= DateTimeToTime(dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_HDEB').AsDateTime);
                    vTFin:= DateTimeToTime(dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_HFIN').AsDateTime);
                    vPlageHoraire.Disponible:= True;
                    if (vPlageHoraire.ATime >= vTDeb) and (vPlageHoraire.ATime <= vTFin) then
                      begin
                        if dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_NBREPLIC').AsInteger = 0 then
                          vPlageHoraire.Disponible:= False;
                        vPlageHoraire.NbReplic:= dmClients.CDS_PARAMHORAIRES.FieldByName('PRHO_NBREPLIC').AsInteger;
                        Break;
                      end;
                  end
                else
...
begin
  ...
  try
    ...
    if vDlgRaisonFrm.ShowModal = mrOk then
      begin
        vDS.Edit;
        vDS.FieldByName('RAIS_ID').AsInteger:= dmClients.CDSRAISONS.FieldByName('RAIS_ID').AsInteger;
        vDS.FieldByName('RAIS_NOM').AsString:= dmClients.CDSRAISONS.FieldByName('RAIS_NOM').AsString;
        vDS.Post;
      end;
  finally
...
begin
  ...
  if (PgCtrlSynthese.ActivePage.Name = 'TbshtSuiviServeurRep') and
    ...
    begin
      Screen.Cursor:= crHourGlass;
      try
        dmClients.DeleteRecordByRessource('SuiviSrvReplication?SSVR_PATH=' + dmClients.CDSSuiviSrvReplication.FieldByName('SSVR_PATH').AsString);

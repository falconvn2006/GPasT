...
uses
  ...
  Dialogs, StdCtrls,
  //Uses perso
  AlgolStdFrm, GinkoiaStyle_dm, AlgolDialogForms, Param_Dm, CstLaunch,
  Jeton_Dm, ProvidersSubscribers_Frm,
  //----------
  ...
  dxSkinXmas2008Blue, dxCntner, dxTL, dxDBCtrl, dxDBGrid, dxDBGridHP,
  cxSpinEdit, cxTextEdit, cxMaskEdit, cxTimeEdit, AdvOfficePager, AdvGlowButton,
  RzLabel, RzPanel, ExtCtrls, GinPanel, AdvEdit, AdvEdBtn, AdvFileNameEdit,
  AdvDirectoryEdit, DBAdvEd, AdvOfficeButtons, DBAdvOfficeButtons;
...
type
  TFrm_ParamReplic = class(TAlgolDialogForm)
    ...
    procedure DBG_ProvidersTChangeNode(Sender: TObject; OldNode,
      Node: TdxTreeListNode);
    procedure btn_SubscriptionEnableLoopClick(Sender: TObject);
    procedure btn_SubscriptionDisableLoopClick(Sender: TObject);
    procedure DBG_SubscriptionTChangeNode(Sender: TObject; OldNode,
      Node: TdxTreeListNode);
    ...
    procedure DBG_ProvidersDCustomDrawCell(Sender: TObject; ACanvas: TCanvas;
      ARect: TRect; ANode: TdxTreeListNode; AColumn: TdxTreeListColumn;
      ASelected, AFocused, ANewItemRow: Boolean; var AText: string;
      var AColor: TColor; AFont: TFont; var AAlignment: TAlignment;
      var ADone: Boolean);
    procedure DBG_SubscriptionDCustomDrawCell(Sender: TObject; ACanvas: TCanvas;
      ARect: TRect; ANode: TdxTreeListNode; AColumn: TdxTreeListColumn;
      ASelected, AFocused, ANewItemRow: Boolean; var AText: string;
      var AColor: TColor; AFont: TFont; var AAlignment: TAlignment;
      var ADone: Boolean);
...
procedure TFrm_ParamReplic.AlgolDialogFormClose(Sender: TObject;
...
begin
  ExecuteProviderSubscribersFrm(False,True,iGlobRepId,
    Dm_Param.IBQue_ProviderDPRO_ID.AsInteger,
    Dm_Param.IBQue_ProviderDPRO_NOM.AsString,
...
procedure TFrm_ParamReplic.btn_SubscriptionDisableLoopClick(Sender: TObject);
var
  idT,
  idD   : Integer;
  sNom  : string;
begin
  try
    ...
    Dm_Param.ModifySubscribers(idT,sNom,0);
...
begin
  ExecuteProviderSubscribersFrm(False,False,iGlobRepId,
    Dm_Param.IBQue_SubscriptionDSUB_ID.AsInteger,
    Dm_Param.IBQue_SubscriptionDSUB_NOM.AsString,
...
begin
  if Winexec(PAnsiChar(de_EAI.Text + 'Delos_QpmAgent.exe'), 0) < 32 then
...
procedure TFrm_ParamReplic.DBG_ProvidersDCustomDrawCell(Sender: TObject;
...
procedure TFrm_ParamReplic.DBG_ProvidersTChangeNode(Sender: TObject; OldNode,
  Node: TdxTreeListNode);
begin
  ed_ProvidersLoop.Text := Dm_Param.IBQue_ProviderTPRO_LOOP.AsString;
end;

procedure TFrm_ParamReplic.DBG_SubscriptionDCustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
  AColumn: TdxTreeListColumn; ASelected, AFocused, ANewItemRow: Boolean;
  var AText: string; var AColor: TColor; AFont: TFont;
  var AAlignment: TAlignment; var ADone: Boolean);
...
procedure TFrm_ParamReplic.DBG_SubscriptionTChangeNode(Sender: TObject; OldNode,
  Node: TdxTreeListNode);
begin
  ed_SubscriptionLoop.Text := Dm_Param.IBQue_SubscriptionTSUB_LOOP.AsString;
end;

...
uses prv.dataModuleConexao, dat.movNotasFiscaisCFOPS;
...
begin
  try
    widnota       := Req.Params['idnota'].ToInteger; // recupera o id da Pessoa
    wconexao      := TProviderDataModuleConexao.Create(nil);
    widempresa    := wconexao.FIdEmpresa; //id empresa do arquivo TrabinApi.ini
    wlista := TJSONArray.Create;
    wlista := dat.movNotasFiscaisCFOPS.RetornaListaCFOPS(Req.Query,widnota);
...
begin
// Método Get
  THorse.Get('/trabinapi/movimentos/notasfiscais/:idnota/cfops',ListaTodosCFOPS);

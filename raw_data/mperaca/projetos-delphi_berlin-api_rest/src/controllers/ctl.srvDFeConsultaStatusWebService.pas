unit ctl.srvDFeConsultaStatusWebService;
...
procedure ConsultaStatusWebService(Req: THorseRequest; Res: THorseResponse; Next: TProc);
...
// Método Get
  THorse.Get('/trabinapi/servicos/dfe/consultastatusws',ConsultaStatusWebService);
// Método Post

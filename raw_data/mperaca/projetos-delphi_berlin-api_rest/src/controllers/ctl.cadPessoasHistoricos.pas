...
uses prv.dataModuleConexao, dat.cadPessoasHistoricos;


procedure ListaTodosHistoricos(Req: THorseRequest; Res: THorseResponse; Next: TProc);
...
begin
  try
    ...
    wlista := dat.cadPessoasHistoricos.RetornaListaHistoricos(Req.Query,widpessoa,wlimit,woffset);
...
procedure RetornaTotalHistoricos(Req: THorseRequest; Res: THorseResponse; Next: TProc);
...
begin
  try
    ...
    wtotal := dat.cadPessoasHistoricos.RetornaTotalHistoricos(Req.Query,widpessoa);
...
procedure RetornaResumoHistoricos(Req: THorseRequest; Res: THorseResponse; Next: TProc);
...
begin
  try
    ...
    wresumo := dat.cadPessoasHistoricos.RetornaResumoHistoricos(Req.Query,widpessoa);
...
begin
// Método Get
  THorse.Get('/trabinapi/cadastros/pessoas/:idpessoa/historicos',ListaTodosHistoricos);
  THorse.Get('/trabinapi/cadastros/pessoas/:idpessoa/historicos/total',RetornaTotalHistoricos);
  THorse.Get('/trabinapi/cadastros/pessoas/:idpessoa/historicos/resumo',RetornaResumoHistoricos);

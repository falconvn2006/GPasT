...
procedure OperacaoNaoRealizada(Req: THorseRequest; Res: THorseResponse; Next: TProc);
...
begin
  try
    ...
    wret      := wdfe.OperacaoNaoRealizada(wchavenfe);
...
// Método Post
  THorse.Post('/trabinapi/servicos/dfe/naorealizada/:chavenfe',OperacaoNaoRealizada);
// Método Delete

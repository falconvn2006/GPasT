unit ctl.srvDFeDesconhecimento;
...
procedure DesconheceOperacao(Req: THorseRequest; Res: THorseResponse; Next: TProc);
...
begin
  try
    ...
    wret      := wdfe.DesconheceOperacao(wchavenfe);
...
// Método Post
  THorse.Post('/trabinapi/servicos/dfe/desconhecimento/:chavenfe',DesconheceOperacao);
// Método Delete

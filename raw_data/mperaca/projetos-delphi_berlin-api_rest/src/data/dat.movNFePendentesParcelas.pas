unit dat.movNFePendentesParcelas;
...
function RetornaNFePendenteParcela(XNFe,XId: integer): TJSONObject;
function RetornaNFePendenteParcelas(XNFe: integer): TJSONArray;
...
// cria provider de conexão com BD
    ...
    if wconexao.EstabeleceConexaoDB then
       ...
       begin
         ...
         SQL.Add('from "Parcela" where "CodigoDocFiscalParcela"=:xnfe and "CodigoInternoParcela"=:xid ');
...
// cria provider de conexão com BD
    ...
    if wconexao.EstabeleceConexaoDB then
       ...
       begin
         ...
         SQL.Add('       "DataOperacaoParcela"     as operacao,');
         SQL.Add('       "TipoOperacaoParcela"     as situacao ');
         SQL.Add('from "Parcela" where "CodigoDocFiscalParcela"=:xnfe ');
         ParamByName('xnfe').AsInteger := XNFe;
         Open;
         EnableControls;
       end;

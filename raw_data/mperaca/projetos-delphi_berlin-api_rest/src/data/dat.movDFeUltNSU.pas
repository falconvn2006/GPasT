...
// cria provider de conexão com BD
    ...
    if wconexao.EstabeleceConexaoDB then
       ...
       begin
         ...
         SQL.Clear;
         Params.Clear;
         SQL.Add('select "CodigoInternoUltimoNSU" as id,');
         SQL.Add('       "CodigoEmpresaUltimoNSU" as idempresa,');
         SQL.Add('       "UltimoNSU"              as ultnsu,');
         SQL.Add('       "DataHoraUltimaConsulta" as ultconsulta,');
         SQL.Add('       "MaximoNSU"              as maxnsu ');
         SQL.Add('FROM "UltimoNSUDFe"  where "CodigoEmpresaUltimoNSU"=:xidempresa ');

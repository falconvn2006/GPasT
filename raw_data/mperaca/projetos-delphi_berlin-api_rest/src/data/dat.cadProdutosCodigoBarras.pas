...
// cria provider de conexão com BD
   ...
   if wquery.RecordCount>0 then
      ...
      begin
        ...
        wret.AddPair('description','Nenhum Código de Barra encontrado');
...
// cria provider de conexão com BD
    ...
    if wqueryLista.RecordCount>0 then
       ...
       begin
         ...
         wobj.AddPair('description','Nenhum Código Barra encontrado');
       ...
       begin
         ...
         if wnum>0 then
            ...
            begin
              wret := TJSONObject.Create;
              wret.AddPair('status','500');
              wret.AddPair('description','Nenhum Código Barra incluído');
              wret.AddPair('datetime',formatdatetime('yyyy-mm-dd hh:nn:ss',now));
            end;
        end;
  except
       ...
       begin
         ...
         if wnum>0 then
           ...
           begin
              wret := TJSONObject.Create;
              wret.AddPair('status','500');
              wret.AddPair('description','Nenhum Código Barra alterado');
              wret.AddPair('datetime',formatdatetime('yyyy-mm-dd hh:nn:ss',now));
            end;
       end;
  ...
  try
    ...
    if wnum>0 then
       begin
         ...
         wret.AddPair('description','Código Barra excluído com sucesso');
       end
    else
       begin
         wret.AddPair('status','500');
         wret.AddPair('description','Nenhum Código Barra excluído');
       end;
    wret.AddPair('datetime',formatdatetime('yyyy-mm-dd hh:nn:ss',now));
  except
    On E: Exception do

...
function RetornaCliente(XId: integer): TJSONObject;
function RetornaListaClientes(const XQuery: TDictionary<string, string>): TJSONArray;
...
// cria provider de conexão com BD
    ...
    if wconexao.EstabeleceConexaoDB then
       ...
       begin
         ...
         SQL.Add('where "CodigoInternoPessoa"=:xid and "AtivoPessoa"=''true'' and "EhClientePessoa"=''true'' ');
   ...
   if wquery.RecordCount>0 then
      ...
      begin
        ...
        wret.AddPair('description','Nenhum cliente encontrado');
...
// cria provider de conexão com BD
    ...
    if wconexao.EstabeleceConexaoDB then
       ...
       begin
         ...
         SQL.Add('       ts_retornalocalidadedescricao("EntregaCodigoCidadePessoa") as cidade, ');
         SQL.Add('       ts_retornalocalidadeuf("EntregaCodigoCidadePessoa") as uf ');
         SQL.Add('from "PessoaGeral" where "CodigoEmpresaPessoa"=:xempresa and "AtivoPessoa"=''true'' and "EhClientePessoa"=''true'' ');
    ...
    if wqueryLista.RecordCount>0 then
       ...
       begin
         ...
         wobj.AddPair('description','Nenhum cliente encontrado');
